...
public class WS_Spells
{
    ...
    public delegate void ApplyAuraHandler(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        int StackCount,
        AuraAction Action);

    public delegate SpellFailedReason SpellEffectHandler(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ref List<WS_Base.BaseObject> Infected,
        ref ItemObject Item);
    ...
    /// <returns></returns>
    public SpellFailedReason ApplyAura(
        ref WS_Base.BaseUnit auraTarget,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID)
    {
        if(auraTarget is null)
        {
            throw new ArgumentNullException(nameof(auraTarget));
        }
        ...
        {
            throw new ArgumentNullException(nameof(SpellInfo));
        }
        ...
        checked
        {
                ...
                do
                {
                    ...
                    if(SpellID == 15007)
                    {
                        Duration = auraTarget.Level switch
                        {
                            ...
                            11 or 12 or 13 or 14 or 15 or 16 or 17 or 18 or 19 => (auraTarget.Level - 10) *
                                60 *
                                1000,
                            _ => 600000,
                        };
                    ...
                    for(var i = num; i >= num2; i += -1)
                    {
                        ...
                        spellCasted = i;
                        if(((auraTarget.ActiveSpells[i].Aura_Info[0] != null) &&
                                (auraTarget.ActiveSpells[i].Aura_Info[0] == SpellInfo)) ||
                            ((auraTarget.ActiveSpells[i].Aura_Info[1] != null) &&
                                (auraTarget.ActiveSpells[i].Aura_Info[1] == SpellInfo)) ||
                            ((auraTarget.ActiveSpells[i].Aura_Info[2] != null) &&
                                (auraTarget.ActiveSpells[i].Aura_Info[2] == SpellInfo)))
                        {
                                ...
                                (auraTarget.ActiveSpells[i].Aura_Info[0] == SpellInfo))
                            {
                                ...
                                if((SPELLs[SpellID].maxStack > 0) &&
                                    (auraTarget.ActiveSpells[i].StackCount < SPELLs[SpellID].maxStack))
                                {
                                    auraTarget.ActiveSpells[i].StackCount++;
                                    AURAs[SpellInfo.ApplyAuraIndex](
                                        ref auraTarget,
                                        ref Caster,
                                        ref SpellInfo,
                                        SpellID,
                                        1,
                                        AuraAction.AURA_ADD);
                                    var auraTarget2 = (WS_Pets.PetObject)auraTarget;
                                    switch(auraTarget)
                                    {
                                        case WS_PlayerData.CharacterObject:
                                            var auraTarget1 = (WS_PlayerData.CharacterObject)auraTarget;
                            ...
                            if(auraTarget.ActiveSpells[i].Aura[0] == null)
                            {
                                ...
                                WorldServiceLocator.WorldServer.Log
                                    .WriteLine(
                                        LogType.DEBUG,
                                        "APPLYING AURA[0] {0}",
                                        (AuraEffects_Names)SpellInfo.ApplyAuraIndex);
                                break;
                            }
            ...
            } catch(Exception e)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(
                        LogType.CRITICAL,
                        "Error while applying aura for spell [Caster:{0}, SpellID:{1}, SpellInfo:{2}, AuraTarget:{3}, Exception:{4}]",
                        Caster,
                        SpellID,
                        SpellInfo,
                        auraTarget,
    ...
    public void CheckDuelDistance(ref WS_PlayerData.CharacterObject objCharacter)
    {
        ...
        if(WorldServiceLocator.WSCombat
                .GetDistance(
                    objCharacter,
                    WorldServiceLocator.WorldServer.WORLD_GAMEOBJECTs[objCharacter.DuelArbiter]) >
            40f)
        {
            if(objCharacter.DuelOutOfBounds == 11)
            {
                Packets.Packets.PacketClass packet2 = new(Opcodes.SMSG_DUEL_OUTOFBOUNDS);
        ...
        } else if(objCharacter.DuelOutOfBounds != 11)
        {
            ...
            Packets.Packets.PacketClass packet = new(Opcodes.SMSG_DUEL_INBOUNDS);
    ...
    public void DuelComplete(ref WS_PlayerData.CharacterObject Winner, ref WS_PlayerData.CharacterObject Loser)
    {
        ...
        Packets.Packets.PacketClass response = new(Opcodes.SMSG_DUEL_COMPLETE);
        response.AddInt8(1);
        ...
        {
            WorldServiceLocator.WorldServer.WORLD_GAMEOBJECTs[Winner.DuelArbiter].Destroy(
                WorldServiceLocator.WorldServer.WORLD_GAMEOBJECTs[Winner.DuelArbiter]);
        }
        ...
        checked
        {
            ...
            Packets.Packets.PacketClass packet = new(Opcodes.SMSG_DUEL_WINNER);
            packet.AddInt8(0);
            ...
            packet.Dispose();
            Packets.Packets.PacketClass SMSG_EMOTE = new(Opcodes.SMSG_EMOTE);
    ...
    /// <param name="r"></param>
    /// <returns></returns>
    public List<WS_Base.BaseUnit> GetEnemyAroundMe(
        ref WS_Base.BaseUnit objCharacter,
        float Distance,
        WS_Base.BaseUnit r = null)
    {
        ...
        {
            case WS_PlayerData.CharacterObject:
                var r1 = (WS_PlayerData.CharacterObject)r;
                foreach(var pGUID2 in r1.playersNear.ToArray())
                {
                    if(WorldServiceLocator.WorldServer.CHARACTERs.ContainsKey(pGUID2) &&
                        ((r1.IsHorde != WorldServiceLocator.WorldServer.CHARACTERs[pGUID2].IsHorde) ||
                            ((r1.DuelPartner != null) &&
                                (r1.DuelPartner == WorldServiceLocator.WorldServer.CHARACTERs[pGUID2]))) &&
                        !WorldServiceLocator.WorldServer.CHARACTERs[pGUID2].IsDead &&
                        (WorldServiceLocator.WSCombat
                                .GetDistance(WorldServiceLocator.WorldServer.CHARACTERs[pGUID2], objCharacter) <
                            Distance))
                    {
                        result.Add(WorldServiceLocator.WorldServer.CHARACTERs[pGUID2]);
                    }
                }
                foreach(var cGUID in r1.creaturesNear.ToArray())
                {
                    if(WorldServiceLocator.WorldServer.WORLD_CREATUREs.ContainsKey(cGUID) &&
                        (WorldServiceLocator.WorldServer.WORLD_CREATUREs[cGUID] is not WS_Totems.TotemObject) &&
                        !WorldServiceLocator.WorldServer.WORLD_CREATUREs[cGUID].IsDead &&
                        (r1.GetReaction(WorldServiceLocator.WorldServer.WORLD_CREATUREs[cGUID].Faction) <=
                            TReaction.NEUTRAL) &&
                        (WorldServiceLocator.WSCombat
                                .GetDistance(WorldServiceLocator.WorldServer.WORLD_CREATUREs[cGUID], objCharacter) <
                            Distance))
                    {
            ...
            case WS_Creatures.CreatureObject:
                foreach(var pGUID in r.SeenBy.ToArray())
                {
                    if(WorldServiceLocator.WorldServer.CHARACTERs.ContainsKey(pGUID) &&
                        !WorldServiceLocator.WorldServer.CHARACTERs[pGUID].IsDead &&
                        (WorldServiceLocator.WorldServer.CHARACTERs[pGUID].GetReaction(
                                ((WS_Creatures.CreatureObject)r).Faction) <=
                            TReaction.NEUTRAL) &&
                        (WorldServiceLocator.WSCombat
                                .GetDistance(WorldServiceLocator.WorldServer.CHARACTERs[pGUID], objCharacter) <
                            Distance))
                    {
    ...
    /// <param name="Distance"></param>
    /// <returns></returns>
    public List<WS_Base.BaseUnit> GetEnemyAtPoint(
        ref WS_Base.BaseUnit objCharacter,
        float PosX,
        float PosY,
        float PosZ,
        float Distance)
    {
        ...
        {
            case WS_PlayerData.CharacterObject:
                var objCharacter1 = (WS_PlayerData.CharacterObject)objCharacter;
                foreach(var pGUID2 in objCharacter1.playersNear.ToArray())
                {
                    if(WorldServiceLocator.WorldServer.CHARACTERs.ContainsKey(pGUID2) &&
                        ((objCharacter1.IsHorde != WorldServiceLocator.WorldServer.CHARACTERs[pGUID2].IsHorde) ||
                            ((objCharacter1.DuelPartner != null) &&
                                (objCharacter1.DuelPartner == WorldServiceLocator.WorldServer.CHARACTERs[pGUID2]))) &&
                        !WorldServiceLocator.WorldServer.CHARACTERs[pGUID2].IsDead &&
                        (WorldServiceLocator.WSCombat
                                .GetDistance(WorldServiceLocator.WorldServer.CHARACTERs[pGUID2], PosX, PosY, PosZ) <
                            Distance))
                    {
                        result.Add(WorldServiceLocator.WorldServer.CHARACTERs[pGUID2]);
                    }
                }
                foreach(var cGUID in objCharacter1.creaturesNear.ToArray())
                {
                    if(WorldServiceLocator.WorldServer.WORLD_CREATUREs.ContainsKey(cGUID) &&
                        (WorldServiceLocator.WorldServer.WORLD_CREATUREs[cGUID] is not WS_Totems.TotemObject) &&
                        !WorldServiceLocator.WorldServer.WORLD_CREATUREs[cGUID].IsDead &&
                        (objCharacter1.GetReaction(WorldServiceLocator.WorldServer.WORLD_CREATUREs[cGUID].Faction) <=
                            TReaction.NEUTRAL) &&
                        (WorldServiceLocator.WSCombat
                                .GetDistance(
            ...
            case WS_Creatures.CreatureObject:
                foreach(var pGUID in objCharacter.SeenBy.ToArray())
                {
                    if(WorldServiceLocator.WorldServer.CHARACTERs.ContainsKey(pGUID) &&
                        !WorldServiceLocator.WorldServer.CHARACTERs[pGUID].IsDead &&
                        (WorldServiceLocator.WorldServer.CHARACTERs[pGUID].GetReaction(
                                ((WS_Creatures.CreatureObject)objCharacter).Faction) <=
                            TReaction.NEUTRAL) &&
                        (WorldServiceLocator.WSCombat
                                .GetDistance(WorldServiceLocator.WorldServer.CHARACTERs[pGUID], PosX, PosY, PosZ) <
                            Distance))
                    {
                        result.Add(WorldServiceLocator.WorldServer.CHARACTERs[pGUID]);
                    }
    ...
    public List<WS_Base.BaseUnit> GetEnemyInBehindMe(ref WS_Base.BaseUnit objCharacter, float Distance)
    {
        ...
        List<WS_Base.BaseUnit> result = new();
        WS_Base.BaseUnit r = null;
        foreach(var unit in GetEnemyAroundMe(ref objCharacter, Distance, r))
        {
    ...
    /// <param name="distance"></param>
    /// <returns></returns>
    public List<WS_Base.BaseUnit> GetPartyMembersAroundMe(
        ...
        float distance)
    {
        ...
        foreach(var GUID in objCharacter.Group.LocalMembers.ToArray())
        {
            if(objCharacter.playersNear.Contains(GUID) &&
                WorldServiceLocator.WorldServer.CHARACTERs.ContainsKey(GUID) &&
                (WorldServiceLocator.WSCombat
                        .GetDistance(objCharacter, WorldServiceLocator.WorldServer.CHARACTERs[GUID]) <
                    distance))
            {
    ...
    /// <param name="PosZ"></param>
    /// <returns></returns>
    public List<WS_Base.BaseUnit> GetPartyMembersAtPoint(
        ref WS_PlayerData.CharacterObject objCharacter,
        float Distance,
        float PosX,
        float PosY,
        float PosZ)
    {
        ...
        foreach(var GUID in objCharacter.Group.LocalMembers.ToArray())
        {
            if(objCharacter.playersNear.Contains(GUID) &&
                WorldServiceLocator.WorldServer.CHARACTERs.ContainsKey(GUID) &&
                (WorldServiceLocator.WSCombat
                        .GetDistance(WorldServiceLocator.WorldServer.CHARACTERs[GUID], PosX, PosY, PosZ) <
                    Distance))
            {
                result.Add(WorldServiceLocator.WorldServer.CHARACTERs[GUID]);
            }
    ...
    public void InitializeSpellDB()
    {
        checked
        {
            ...
            SPELL_EFFECTs[4] = SPELL_EFFECT_NOT_IMPLEMENTED;
            ...
            SPELL_EFFECTs[9] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[10] = SPELL_EFFECT_HEAL;
            SPELL_EFFECTs[11] = SPELL_EFFECT_BIND;
            SPELL_EFFECTs[12] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[13] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[14] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[15] = SPELL_EFFECT_NOT_IMPLEMENTED;
            ...
            SPELL_EFFECTs[19] = SPELL_EFFECT_NOT_IMPLEMENTED;
            ...
            SPELL_EFFECTs[25] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[26] = SPELL_EFFECT_NOT_IMPLEMENTED;
            ...
            SPELL_EFFECTs[31] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[32] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[33] = SPELL_EFFECT_OPEN_LOCK;
            SPELL_EFFECTs[34] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[35] = SPELL_EFFECT_APPLY_AREA_AURA;
            SPELL_EFFECTs[36] = SPELL_EFFECT_LEARN_SPELL;
            SPELL_EFFECTs[37] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[38] = SPELL_EFFECT_DISPEL;
            SPELL_EFFECTs[39] = SPELL_EFFECT_NOT_IMPLEMENTED;
            ...
            SPELL_EFFECTs[43] = SPELL_EFFECT_SUMMON_PET;
            SPELL_EFFECTs[44] = SPELL_EFFECT_SKILL_STEP;
            SPELL_EFFECTs[45] = SPELL_EFFECT_HONOR;
            SPELL_EFFECTs[46] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[47] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[48] = SPELL_EFFECT_STEALTH;
            SPELL_EFFECTs[49] = SPELL_EFFECT_DETECT;
            //SPELL_EFFECTs[50] = SPELL_EFFECT_SUMMON_OBJECT;
            SPELL_EFFECTs[50] = SPELL_EFFECT_NOT_IMPLEMENTED; // ^
            SPELL_EFFECTs[51] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[52] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[53] = SPELL_EFFECT_ENCHANT_ITEM;
            SPELL_EFFECTs[54] = SPELL_EFFECT_ENCHANT_ITEM_TEMPORARY;
            SPELL_EFFECTs[55] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[56] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[57] = SPELL_EFFECT_NOT_IMPLEMENTED;
            ...
            SPELL_EFFECTs[61] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[62] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[63] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[64] = SPELL_EFFECT_TRIGGER_SPELL;
            SPELL_EFFECTs[65] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[67] = SPELL_EFFECT_HEAL_MAX_HEALTH;
            SPELL_EFFECTs[68] = SPELL_EFFECT_INTERRUPT_CAST;
            SPELL_EFFECTs[69] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[70] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[71] = SPELL_EFFECT_PICKPOCKET;
            SPELL_EFFECTs[72] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[73] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[74] = SPELL_EFFECT_SUMMON_TOTEM;
            SPELL_EFFECTs[75] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[76] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[77] = SPELL_EFFECT_SCRIPT_EFFECT;
            SPELL_EFFECTs[78] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[79] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[80] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[81] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[82] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[83] = SPELL_EFFECT_DUEL;
            SPELL_EFFECTs[84] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[85] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[86] = SPELL_EFFECT_NOT_IMPLEMENTED;
            ...
            SPELL_EFFECTs[91] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[92] = SPELL_EFFECT_ENCHANT_HELD_ITEM;
            SPELL_EFFECTs[93] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[94] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[95] = SPELL_EFFECT_SKINNING;
            SPELL_EFFECTs[96] = SPELL_EFFECT_CHARGE;
            SPELL_EFFECTs[97] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[98] = SPELL_EFFECT_KNOCK_BACK;
            SPELL_EFFECTs[99] = SPELL_EFFECT_DISENCHANT;
            SPELL_EFFECTs[100] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[101] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[102] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[103] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[104] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[105] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[106] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[107] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[108] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[109] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[110] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[111] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[112] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[113] = SPELL_EFFECT_RESURRECT_NEW;
            SPELL_EFFECTs[114] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[115] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[116] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[117] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[118] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[119] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[120] = SPELL_EFFECT_TELEPORT_GRAVEYARD;
            SPELL_EFFECTs[121] = SPELL_EFFECT_ADDICTIONAL_DMG;
            SPELL_EFFECTs[122] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[123] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[124] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[125] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[126] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[127] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[128] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[129] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[130] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[131] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[132] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[133] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[134] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[135] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[136] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[137] = SPELL_EFFECT_ENERGIZE_PCT;
            SPELL_EFFECTs[138] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[139] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[140] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[141] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[142] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[143] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[144] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[145] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[146] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[147] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[148] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[149] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[150] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[151] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[152] = SPELL_EFFECT_NOT_IMPLEMENTED;
            SPELL_EFFECTs[153] = SPELL_EFFECT_NOT_IMPLEMENTED;
            var i = 0;
            do
            {
            ...
            AURAs[5] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[6] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[7] = SPELL_AURA_MOD_FEAR;
            AURAs[8] = SPELL_AURA_PERIODIC_HEAL;
            AURAs[9] = SPELL_AURA_NOT_IMPLEMENTED;
            ...
            AURAs[14] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[15] = SPELL_AURA_NOT_IMPLEMENTED;
            ...
            AURAs[37] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[38] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[39] = SPELL_AURA_SCHOOL_IMMUNITY;
            AURAs[40] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[41] = SPELL_AURA_DISPEL_IMMUNITY;
            AURAs[42] = SPELL_AURA_PROC_TRIGGER_SPELL;
            AURAs[43] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[44] = SPELL_AURA_TRACK_CREATURES;
            AURAs[45] = SPELL_AURA_TRACK_RESOURCES;
            AURAs[46] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[47] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[48] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[49] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[50] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[51] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[52] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[53] = SPELL_AURA_PERIODIC_LEECH;
            AURAs[54] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[55] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[56] = SPELL_AURA_TRANSFORM;
            AURAs[57] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[58] = SPELL_AURA_MOD_INCREASE_SWIM_SPEED;
            AURAs[59] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[60] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[61] = SPELL_AURA_MOD_SCALE;
            AURAs[62] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[63] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[64] = SPELL_AURA_PERIODIC_MANA_LEECH;
            AURAs[65] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[66] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[67] = SPELL_AURA_MOD_DISARM;
            AURAs[68] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[69] = SPELL_AURA_SCHOOL_ABSORB;
            AURAs[70] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[71] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[72] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[73] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[74] = SPELL_AURA_NOT_IMPLEMENTED;
            ...
            AURAs[81] = SPELL_AURA_NOT_IMPLEMENTED;
            ...
            AURAs[86] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[87] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[88] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[89] = SPELL_AURA_PERIODIC_DAMAGE_PERCENT;
            AURAs[90] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[91] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[92] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[93] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[94] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[95] = SPELL_AURA_GHOST;
            AURAs[96] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[97] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[98] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[99] = SPELL_AURA_MOD_ATTACK_POWER;
            AURAs[100] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[101] = SPELL_AURA_MOD_RESISTANCE_PCT;
            AURAs[102] = SPELL_AURA_NOT_IMPLEMENTED;
            ...
            AURAs[109] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[110] = SPELL_AURA_MOD_POWER_REGEN_PERCENT;
            AURAs[111] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[112] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[113] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[114] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[115] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[116] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[117] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[118] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[119] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[120] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[121] = SPELL_AURA_EMPATHY;
            AURAs[122] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[123] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[124] = SPELL_AURA_MOD_RANGED_ATTACK_POWER;
            AURAs[125] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[126] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[127] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[128] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[129] = SPELL_AURA_MOD_INCREASE_SPEED_ALWAYS;
            AURAs[130] = SPELL_AURA_MOD_INCREASE_MOUNTED_SPEED_ALWAYS;
            AURAs[131] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[132] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[133] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[134] = SPELL_AURA_NOT_IMPLEMENTED;
            ...
            AURAs[139] = SPELL_AURA_NOT_IMPLEMENTED;
            ...
            AURAs[145] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[146] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[147] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[148] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[149] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[150] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[151] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[152] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[153] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[154] = SPELL_AURA_MOD_STEALTH_LEVEL;
            AURAs[155] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[156] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[157] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[158] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[159] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[160] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[161] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[162] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[163] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[164] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[165] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[166] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[167] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[168] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[169] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[170] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[171] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[172] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[173] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[174] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[175] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[176] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[177] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[178] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[179] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[180] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[181] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[182] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[183] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[184] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[185] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[186] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[187] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[188] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[189] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[190] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[191] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[192] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[193] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[194] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[195] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[196] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[197] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[198] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[199] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[200] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[201] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[202] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[203] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[204] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[205] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[206] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[207] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[208] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[209] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[210] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[211] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[212] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[213] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[214] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[215] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[216] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[217] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[218] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[219] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[220] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[221] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[222] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[223] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[224] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[225] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[226] = SPELL_AURA_PERIODIC_DUMMY;
            AURAs[227] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[228] = SPELL_AURA_DETECT_STEALTH;
            AURAs[229] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[230] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[231] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[232] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[233] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[234] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[235] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[236] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[237] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[238] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[239] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[240] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[241] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[242] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[243] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[244] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[245] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[246] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[247] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[248] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[249] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[250] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[251] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[252] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[253] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[254] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[255] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[256] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[257] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[258] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[259] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[260] = SPELL_AURA_NOT_IMPLEMENTED;
            AURAs[261] = SPELL_AURA_NOT_IMPLEMENTED;
        }
    }
    ...
    public void On_CMSG_CANCEL_AURA(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
        ...
        if(checked(packet.Data.Length - 1) >= 9)
        {
            ...
            WorldServiceLocator.WorldServer.Log
                .WriteLine(
                    LogType.DEBUG,
                    "[{0}:{1}] CMSG_CANCEL_AURA [spellID={2}]",
                    client.IP,
                    client.Port,
                    spellID);
    ...
    /// <param name="packet"></param>
    /// <param name="client"></param>
    public void On_CMSG_CANCEL_AUTO_REPEAT_SPELL(
        ...
        ref WS_Network.ClientClass client)
    {
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_CANCEL_AUTO_REPEAT_SPELL", client.IP, client.Port);
    ...
    /// <param name="packet"></param>
    /// <param name="client"></param>
    public void On_CMSG_CANCEL_CAST(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
        ...
        if((checked(packet.Data.Length - 1) >= 9) && (client.Character != null))
        {
            ...
            var SpellID = packet.GetInt32();
            WorldServiceLocator.WorldServer.Log
                .WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_CANCEL_CAST", client.IP, client.Port);
            ...
            } else if((client.Character.spellCasted[2] != null) &&
                (client.Character.spellCasted[2].SpellID == SpellID))
            {
                client.Character.FinishSpell(CurrentSpellTypes.CURRENT_AUTOREPEAT_SPELL);
            } else if((client.Character.spellCasted[3] != null) &&
                (client.Character.spellCasted[3].SpellID == SpellID))
            {
                client.Character.FinishSpell(CurrentSpellTypes.CURRENT_CHANNELED_SPELL);
            } else if((client.Character.spellCasted[0] != null) &&
                (client.Character.spellCasted[0].SpellID == SpellID))
            {
    ...
    /// <param name="packet"></param>
    /// <param name="client"></param>
    public void On_CMSG_CANCEL_CHANNELLING(
        ref Packets.Packets.PacketClass packet,
        ref WS_Network.ClientClass client)
    {
        if(packet is null)
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_CANCEL_CHANNELLING", client.IP, client.Port);
        client.Character.FinishSpell(CurrentSpellTypes.CURRENT_CHANNELED_SPELL);
    }
    ...
    /// <param name="packet"></param>
    /// <param name="client"></param>
    public void On_CMSG_CAST_SPELL(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
        ...
        var spellID = packet.GetInt32();
        WorldServiceLocator.WorldServer.Log
            .WriteLine(LogType.DEBUG, "[{0}:{1}] CSMG_CAST_SPELL [spellID={2}]", client.IP, client.Port, spellID);
        if(client.Character == null)
        {
            WorldServiceLocator.WorldServer.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] WS_Spells:On_CMSG_CAST_SPELL Null Character Object [spellID={2}]",
                    client.IP,
                    client.Port,
                    spellID);
            return;
        }
        if (client.Character?.HaveSpell(spellID) == false)
        {
            WorldServiceLocator.WorldServer.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] CHEAT: Character {2} casting unlearned spell {3}!",
                    client.IP,
                    client.Port,
        ...
        if (!SPELLs.ContainsKey(spellID))
        {
            WorldServiceLocator.WorldServer.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] Character tried to cast a spell that didn't exist: {2}!",
                    client.IP,
                    client.Port,
                    spellID);
            return;
        ...
        try
        {
            ...
            if((client.Character.spellCasted[spellType]?.Finished) == false)
            {
        ...
        {
            WorldServiceLocator.WorldServer.Log
                .WriteLine(LogType.FAILED, "Error casting spell {0}.{1}", spellID, $"{Environment.NewLine}{e}");
            SendCastResult(castResult, ref client, spellID);
        }
    }
    ...
    /// <param name="packet"></param>
    /// <param name="client"></param>
    public void On_CMSG_DUEL_ACCEPTED(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
        ...
        if(checked(packet.Data.Length - 1) >= 13)
        {
            ...
            WorldServiceLocator.WorldServer.Log
                .WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_DUEL_ACCEPTED [{2:X}]", client.IP, client.Port, GUID);
            if(client.Character.DuelArbiter == GUID)
            {
                ...
                Packets.Packets.PacketClass response = new(Opcodes.SMSG_DUEL_COUNTDOWN);
                response.AddInt32(3000);
                c1.client.SendMultiplyPackets(ref response);
                c2.client.SendMultiplyPackets(ref response);
                response.Dispose();
                Thread StartDuel = new(c2.StartDuel) { Name = "Duel timer" };
                StartDuel.Start();
            }
        }
    }
    ...
    /// <param name="packet"></param>
    /// <param name="client"></param>
    public void On_CMSG_DUEL_CANCELLED(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
        ...
        if(checked(packet.Data.Length - 1) >= 13)
        {
            ...
            var GUID = packet.GetUInt64();
            WorldServiceLocator.WorldServer.Log
                .WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_DUEL_CANCELLED [{2:X}]", client.IP, client.Port, GUID);
    ...
    /// <param name="packet"></param>
    /// <param name="client"></param>
    public void On_CMSG_LEARN_TALENT(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
        ...
        checked
        {
            try
            {
                ...
                if((CurrentTalentPoints == 0) ||
                    ...
                    ((RequestedRank > 0) &&
                        !client.Character
                            .HaveSpell(
                                WorldServiceLocator.WSDBCDatabase.Talents[TalentID].RankID[RequestedRank - 1])))
                {
                    return;
                }
                var k = 0;
                do
                {
                    if(WorldServiceLocator.WSDBCDatabase.Talents[TalentID].RequiredTalent[k] > 0)
                    {
                        ...
                        for(var j = num; j <= 4; j++)
                        {
                            if((WorldServiceLocator.WSDBCDatabase.Talents[DependsOn].RankID[j] != 0) &&
                                client.Character
                                    .HaveSpell(WorldServiceLocator.WSDBCDatabase.Talents[DependsOn].RankID[j]))
                            {
                                HasEnoughRank = true;
                            }
                        }
                ...
                if(WorldServiceLocator.WSDBCDatabase.Talents[TalentID].Row > 0)
                {
                    ...
                    {
                        if(WorldServiceLocator.WSDBCDatabase.Talents[TalentID].TalentTab !=
                            TalentInfo.Value.TalentTab)
                        {
                            continue;
                        }
                        var i = 0;
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "_WS_DBCDatabase.Talents spent: {0}", SpentPoints);
                ...
                if((SpellID != 0) && !client.Character.HaveSpell(SpellID))
                {
                    ...
                    if(RequestedRank > 0)
                    {
                        var ReSpellID = WorldServiceLocator.WSDBCDatabase.Talents[TalentID].RankID[
                            RequestedRank - 1];
            ...
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "Error learning talent: {0}{1}", Environment.NewLine, e.ToString());
            }
        }
    }
    ...
    /// <param name="packet"></param>
    /// <param name="client"></param>
    public void On_CMSG_RESURRECT_RESPONSE(
        ref Packets.Packets.PacketClass packet,
        ref WS_Network.ClientClass client)
    {
        if(packet is null)
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(
                LogType.DEBUG,
                "[{0}:{1}] CMSG_RESURRECT_RESPONSE [GUID={2:X} Status={3}]",
                client.IP,
                client.Port,
                GUID,
                Status);
        ...
        } else if(GUID == client.Character.resurrectGUID)
        {
            ...
            client.Character
                .Teleport(
                    client.Character.resurrectPositionX,
                    client.Character.resurrectPositionY,
                    client.Character.resurrectPositionZ,
                    client.Character.orientation,
                    client.Character.resurrectMapID);
        }
    }
    ...
    public void SendCastResult(SpellFailedReason result, ref WS_Network.ClientClass client, int id)
    {
        ...
        Packets.Packets.PacketClass packet = new(Opcodes.SMSG_CAST_RESULT);
        packet.AddInt32(id);
    ...
    public void SendChannelUpdate(ref WS_PlayerData.CharacterObject Caster, int Time)
    {
        ...
        Packets.Packets.PacketClass packet = new(Opcodes.MSG_CHANNEL_UPDATE);
    ...
    public void SendEnergizeSpellLog(
        ref WS_Base.BaseUnit Caster,
        ref WS_Base.BaseUnit Target,
        int SpellID,
        int Damage,
        int PowerType)
        ...
        bool CriticalHit)
    {
        ...
        Packets.Packets.PacketClass packet = new(Opcodes.SMSG_HEALSPELL_ON_PLAYER_OBSOLETE);
    ...
    /// <param name="CriticalHit"></param>
    public void SendNonMeleeDamageLog(
        ref WS_Base.BaseUnit Caster,
        ref WS_Base.BaseUnit Target,
        int SpellID,
        int SchoolType,
        ...
        bool CriticalHit)
    {
        ...
        Packets.Packets.PacketClass packet = new(Opcodes.SMSG_SPELLNONMELEEDAMAGELOG);
        packet.AddPackGUID(Target.GUID);
        packet.AddPackGUID(Caster.GUID);
        packet.AddInt32(SpellID);
        packet.AddInt32(Damage);
    ...
    public void SendPeriodicAuraLog(
        ref WS_Base.BaseUnit Caster,
        ref WS_Base.BaseUnit Target,
        int SpellID,
        int School,
        ...
        int AuraIndex)
    {
        ...
        Packets.Packets.PacketClass packet = new(Opcodes.SMSG_PERIODICAURALOG);
        packet.AddPackGUID(Target.GUID);
        packet.AddPackGUID(Caster.GUID);
        packet.AddInt32(SpellID);
        packet.AddInt32(1);
    ...
    public void SendPlaySpellVisual(ref WS_Base.BaseUnit Caster, int SpellId)
    {
        ...
        Packets.Packets.PacketClass packet = new(Opcodes.SMSG_PLAY_SPELL_VISUAL);
    ...
    public void SPELL_AURA_ADD_FLAT_MODIFIER(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        var caster = (WS_Base.BaseUnit)Caster;
            ...
            switch(Action)
            {
                case AuraAction.AURA_ADD:
                    ...
                    do
                    {
                        if((mask & shiftdata) != 0)
                        {
                            Packets.Packets.PacketClass packet = new(Opcodes.SMSG_SET_FLAT_SPELL_MODIFIER);
                            packet.AddInt8((byte)eff);
                            packet.AddInt8((byte)op);
                            packet.AddUInt16(send_val);
                            packet.AddUInt16(send_mark);
                            var caster1 = (WS_PlayerData.CharacterObject)Caster;
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_ADD_PCT_MODIFIER(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
            ...
            switch(Action)
            {
                case AuraAction.AURA_ADD:
                    ...
                    do
                    {
                        if((mask & shiftdata) != 0)
                        {
                            Packets.Packets.PacketClass packet = new(Opcodes.SMSG_SET_PCT_SPELL_MODIFIER);
                            packet.AddInt8((byte)eff);
                            packet.AddInt8((byte)op);
                            packet.AddUInt16(send_val);
                            packet.AddUInt16(send_mark);
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_BIND_SIGHT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_DETECT_STEALTH(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_DISPEL_IMMUNITY(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(
                LogType.DEBUG,
                "[DEBUG] Aura Dummy for spell. [Target:{0} Caster:{1} EffectInfo:{2} SpellID:{3} StackCount:{4} Action:{5}]",
                Target,
                Caster,
                EffectInfo,
                SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_EMPATHY(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        switch(Action)
        {
            ...
            case AuraAction.AURA_REMOVEBYDURATION:
                ...
                {
                    Packets.Packets.UpdatePacketClass packet2 = new();
                    Packets.Packets.UpdateClass tmpUpdate2 = new(188);
                    tmpUpdate2.SetUpdateFlag(143, Target.cDynamicFlags);
                    Packets.Packets.PacketClass packet3 = packet2;
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_FAR_SIGHT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_FEATHER_FALL(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        switch(Action)
        {
            ...
            case AuraAction.AURA_ADD:
                Packets.Packets.PacketClass packet = new(Opcodes.SMSG_MOVE_FEATHER_FALL);
                packet.AddPackGUID(Target.GUID);
            ...
            case AuraAction.AURA_REMOVE:
            case AuraAction.AURA_REMOVEBYDURATION:
                Packets.Packets.PacketClass packet2 = new(Opcodes.SMSG_MOVE_NORMAL_FALL);
        ...
        AuraAction Action)
    {
        ...
        switch(Action)
        {
            ...
            case AuraAction.AURA_ADD:
                Packets.Packets.PacketClass packet = new(Opcodes.SMSG_MOVE_SET_HOVER);
                packet.AddPackGUID(Target.GUID);
                Target.SendToNearPlayers(ref packet);
                packet.Dispose();
                break;
            case AuraAction.AURA_REMOVE:
            case AuraAction.AURA_REMOVEBYDURATION:
                Packets.Packets.PacketClass packet2 = new(Opcodes.SMSG_MOVE_UNSET_HOVER);
                packet2.AddPackGUID(Target.GUID);
                Target.SendToNearPlayers(ref packet2);
                packet2.Dispose();
                break;
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MECHANIC_IMMUNITY(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_ATTACK_POWER(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_BASE_RESISTANCE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        switch(Action)
        {
            ...
            case AuraAction.AURA_ADD:
                ...
                do
                {
                    ...
                    {
                        var target = (WS_PlayerData.CharacterObject)Target;
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_BASE_RESISTANCE_PCT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_DAMAGE_DONE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        var target1 = (WS_PlayerData.CharacterObject)Target;
        switch(Action)
        {
            case AuraAction.AURA_UPDATE:
                return;
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_DAMAGE_DONE_PCT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_DECREASE_SPEED(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        switch(Action)
        {
            case AuraAction.AURA_ADD:
                if(Target is WS_PlayerData.CharacterObject @object)
                {
                    ...
                    var caster = (WS_Base.BaseUnit)Caster;
                    newSpeed = (EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) >= 0)
                        ? ((float)(newSpeed /
                            ((EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) / 100.0) + 1.0)))
                        : ((float)(newSpeed /
                            (Math.Abs(EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) / 100.0) + 1.0)));
                ...
                } else if(Target is WS_Creatures.CreatureObject object1)
                {
                    ...
                    switch(EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0))
                    {
                        case < 0:
                            ...
                            speedMod3 = (float)(speedMod3 /
                                (Math.Abs(EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) / 100.0) + 1.0));
                            break;

                        default:
                            ref var speedMod4 = ref object1.SpeedMod;
                            speedMod4 = (float)(speedMod4 /
                                ((EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) / 100.0) + 1.0));
                            break;
                    }
                }
            ...
            case AuraAction.AURA_REMOVEBYDURATION:
                if(Target is WS_PlayerData.CharacterObject object2)
                {
                    ...
                    var caster = (WS_Base.BaseUnit)Caster;
                    newSpeed2 = (EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) >= 0)
                        ? ((float)(newSpeed2 *
                            ((EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) / 100.0) + 1.0)))
                        : ((float)(newSpeed2 *
                            (Math.Abs(EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) / 100.0) + 1.0)));
                ...
                } else if(Target is WS_Creatures.CreatureObject object1)
                {
                    ...
                    switch(EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0))
                    {
                        case < 0:
                            ...
                            speedMod = (float)(speedMod *
                                (Math.Abs(EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) / 100.0) + 1.0));
                            break;

                        default:
                            ref var speedMod2 = ref object1.SpeedMod;
                            speedMod2 = (float)(speedMod2 *
                                ((EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) / 100.0) + 1.0));
                            break;
                    }
                }
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_DETECT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_DISARM(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_FEAR(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        Packets.Packets.PacketClass response = new(Opcodes.SMSG_DEATH_NOTIFY_OBSOLETE);
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_HASTE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_HEALING_DONE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_HEALING_DONE_PCT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_INCREASE_ENERGY(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        switch(Action)
        {
            ...
            case AuraAction.AURA_ADD:
                ...
                checked
                {
                    var caster1 = (WS_Base.BaseUnit)Caster;
                    if(Target is not WS_PlayerData.CharacterObject)
                    {
                        var caster = caster1;
        ...
        Packets.Packets.PacketClass packet2 = packet;
        var target1 = (WS_Creatures.CreatureObject)Target;
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_INCREASE_HEALTH(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        checked
        {
            ...
            Packets.Packets.PacketClass packet2 = packet;
            var target = (WS_Creatures.CreatureObject)Target;
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_INCREASE_HEALTH_PERCENT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_INCREASE_MOUNTED_SPEED(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_INCREASE_MOUNTED_SPEED_ALWAYS(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_INCREASE_SPEED(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_INCREASE_SPEED_ALWAYS(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_INCREASE_SWIM_SPEED(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_INVISIBILITY(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_INVISIBILITY_DETECTION(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        checked
        {
            ...
            switch(Action)
            {
                ...
                case AuraAction.AURA_ADD:
                    Target.CanSeeInvisibility_Invisibility += EffectInfo.GetValue(
                        Level: caster.Level,
                        ComboPoints: 0);
                    break;
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_LANGUAGE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_PACIFY(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        switch(Action)
        {
            ...
            case AuraAction.AURA_ADD:
                Target.Spell_Pacified = true;
                break;

            case AuraAction.AURA_REMOVE:
            case AuraAction.AURA_REMOVEBYDURATION:
                Target.Spell_Pacified = false;
                break;
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_POSSESS(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        switch(Action)
        {
            ...
            case AuraAction.AURA_ADD:
                ...
                if(Target.Level <= EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0))
                {
                    ...
                    Packets.Packets.PacketClass packet8;
                    var target = (WS_Creatures.CreatureObject)Target;
                    switch(Target)
                    {
                        case WS_PlayerData.CharacterObject:
                            ...
                            updateClass5.AddToPacket(
                                ref packet8,
                                ObjectUpdateType.UPDATETYPE_VALUES,
                                ref updateObject);
                            packet = (Packets.Packets.UpdatePacketClass)packet8;
                            break;
                    ...
                    packet.Dispose();
                    tmpUpdate.Dispose();
                    packet = new Packets.Packets.UpdatePacketClass();
                    tmpUpdate = new Packets.Packets.UpdateClass(188);
                    ...
                    if(Caster is WS_PlayerData.CharacterObject @object)
                    {
                        ...
                        Caster = updateObject;
                        Packets.Packets.PacketClass packet6 = new(Opcodes.SMSG_DEATH_NOTIFY_OBSOLETE);
                    ...
                    switch(Target)
                    {
                        ...
                        case WS_PlayerData.CharacterObject object1:
                            Packets.Packets.PacketClass packet3 = new(Opcodes.SMSG_DEATH_NOTIFY_OBSOLETE);
            ...
            case AuraAction.AURA_REMOVEBYDURATION:
            {
                ...
                switch(Target)
                {
                    case WS_PlayerData.CharacterObject:
                    {
                        ...
                        packet2 = (Packets.Packets.UpdatePacketClass)packet8;
                        break;
                    }
                ...
                packet2.Dispose();
                tmpUpdate2.Dispose();
                packet2 = new Packets.Packets.UpdatePacketClass();
                tmpUpdate2 = new Packets.Packets.UpdateClass(188);
                ...
                if(Caster is WS_PlayerData.CharacterObject @object)
                {
                    Packets.Packets.PacketClass packet5 = new(Opcodes.SMSG_PET_SPELLS);
                    packet5.AddUInt64(0uL);
                    @object.client.Send(ref packet5);
                    packet5.Dispose();
                    Packets.Packets.PacketClass packet7 = new(Opcodes.SMSG_DEATH_NOTIFY_OBSOLETE);
                ...
                switch(Target)
                {
                    ...
                    case WS_PlayerData.CharacterObject object1:
                        Packets.Packets.PacketClass packet4 = new(Opcodes.SMSG_DEATH_NOTIFY_OBSOLETE);
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_POWER_REGEN(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_POWER_REGEN_PERCENT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        checked
        {
            switch(Action)
            {
                ...
                case AuraAction.AURA_ADD:
                    ...
                    {
                        var caster = (WS_Base.BaseUnit)Caster;
                        var Damage2 = (int)Math.Round(
                            EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) * StackCount / 100.0);
                        var target = (WS_PlayerData.CharacterObject)Target;
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_RANGED_AMMO_HASTE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_RANGED_ATTACK_POWER(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        checked
        {
            ...
            switch(Action)
            {
                ...
                case AuraAction.AURA_ADD:
                    Target.AttackPowerModsRanged += EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) *
                        StackCount;
                    break;
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_RANGED_HASTE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_REGEN(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_RESISTANCE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        var target2 = (WS_PlayerData.CharacterObject)Target;
        switch(Action)
        {
            case AuraAction.AURA_UPDATE:
                return;
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_RESISTANCE_EXCLUSIVE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_RESISTANCE_PCT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_ROOT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_SCALE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        Packets.Packets.UpdatePacketClass packet = new();
        Packets.Packets.UpdateClass tmpUpdate = new(6);
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_SHAPESHIFT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        switch(Action)
        {
            case AuraAction.AURA_ADD:
                ...
                if((Target is WS_PlayerData.CharacterObject object1) &&
                    (object1.Class == Classes.CLASS_DRUID) &&
                    ((EffectInfo.MiscValue == 4) ||
                        (EffectInfo.MiscValue == 1) ||
                        (EffectInfo.MiscValue == 5) ||
                        (EffectInfo.MiscValue == 8) ||
                        (EffectInfo.MiscValue == 3) ||
                        (EffectInfo.MiscValue == 29) ||
                        (EffectInfo.MiscValue == 27) ||
                        (EffectInfo.MiscValue == 31)))
                {
                    var obj2 = Target;
                    NotSpellID = 0;
                ...
                Target.ManaType = WorldServiceLocator.CommonGlobalFunctions
                    .GetShapeshiftManaType((ShapeshiftForm)checked((byte)EffectInfo.MiscValue), Target.ManaType);
                Target.Model = Target switch
                {
                    WS_PlayerData.CharacterObject => WorldServiceLocator.CommonGlobalFunctions
                        .GetShapeshiftModel(
                            (ShapeshiftForm)checked((byte)EffectInfo.MiscValue),
                            Target.Race,
                            Target.Model),
                    _ => WorldServiceLocator.CommonGlobalFunctions
                        .GetShapeshiftModel((ShapeshiftForm)checked((byte)EffectInfo.MiscValue), 0, Target.Model),
                };
                break;
            case AuraAction.AURA_REMOVE:
            case AuraAction.AURA_REMOVEBYDURATION:
                ...
                if(Target is WS_PlayerData.CharacterObject @object)
                {
                    Target.ManaType = WorldServiceLocator.WSPlayerInitializator.GetClassManaType(@object.Class);
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_SILENCE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_SKILL(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        checked
        {
            switch(Action)
            {
                ...
                case AuraAction.AURA_ADD:
                    if((Target is WS_PlayerData.CharacterObject @object) &&
                        @object.Skills.ContainsKey(EffectInfo.MiscValue))
                    {
                        ...
                        characterObject2.SetUpdateFlag(
                            718 + (characterObject2.SkillsPositions[EffectInfo.MiscValue] * 3) + 2,
                            characterObject2.Skills[EffectInfo.MiscValue].Bonus);
                ...
                case AuraAction.AURA_REMOVEBYDURATION:
                    if((Target is WS_PlayerData.CharacterObject object1) &&
                        object1.Skills.ContainsKey(EffectInfo.MiscValue))
                    {
                        ...
                        characterObject.SetUpdateFlag(
                            718 + (characterObject.SkillsPositions[EffectInfo.MiscValue] * 3) + 2,
                            characterObject.Skills[EffectInfo.MiscValue].Bonus);
                        characterObject.SendCharacterUpdate();
                    }
                    break;
    ...
    public void SPELL_AURA_MOD_STAT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        checked
        {
            ...
            if(WorldServiceLocator.WSPlayerInitializator.GetClassManaType(target1.Class) == ManaTypes.TYPE_MANA)
            {
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_STAT_PERCENT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        if((Action != AuraAction.AURA_UPDATE) && (Target is WS_PlayerData.CharacterObject @object))
        {
            ...
            checked
            {
                ...
                switch(EffectInfo.MiscValue)
                {
                    case -1:
                    {
                        WS_PlayerHelper.TStat spirit;
                            (spirit = @object.Strength).RealBase = (int)Math.Round(
                                spirit.RealBase / @object.Strength.BaseModifier);
                        @object.Strength.BaseModifier += value;
                            (spirit = @object.Strength).RealBase = (int)Math.Round(
                                spirit.RealBase * @object.Strength.BaseModifier);
                            (spirit = @object.Agility).RealBase = (int)Math.Round(
                                spirit.RealBase / @object.Agility.BaseModifier);
                        @object.Agility.BaseModifier += value;
                            (spirit = @object.Agility).RealBase = (int)Math.Round(
                                spirit.RealBase * @object.Agility.BaseModifier);
                            (spirit = @object.Stamina).RealBase = (int)Math.Round(
                                spirit.RealBase / @object.Stamina.BaseModifier);
                        @object.Stamina.BaseModifier += value;
                            (spirit = @object.Stamina).RealBase = (int)Math.Round(
                                spirit.RealBase * @object.Stamina.BaseModifier);
                            (spirit = @object.Spirit).RealBase = (int)Math.Round(
                                spirit.RealBase / @object.Spirit.BaseModifier);
                        @object.Spirit.BaseModifier += value;
                            (spirit = @object.Spirit).RealBase = (int)Math.Round(
                                spirit.RealBase * @object.Spirit.BaseModifier);
                            (spirit = @object.Intellect).RealBase = (int)Math.Round(
                                spirit.RealBase / @object.Intellect.BaseModifier);
                ...
                if(WorldServiceLocator.WSPlayerInitializator.GetClassManaType(@object.Class) == ManaTypes.TYPE_MANA)
                {
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_STEALTH(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_STEALTH_LEVEL(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_STUN(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_TAUNT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_THREAT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_TOTAL_STAT_PERCENTAGE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        checked
        {
            ...
            if(WorldServiceLocator.WSPlayerInitializator.GetClassManaType(target.Class) == ManaTypes.TYPE_MANA)
            {
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOD_TOTAL_THREAT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        switch(Action)
        {
            ...
            case AuraAction.AURA_ADD:
                Value = (Target is not WS_PlayerData.CharacterObject)
                    ? EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0)
                    : EffectInfo.GetValue(Target.Level, 0);
                break;
        ...
        switch(Target)
        {
            case WS_PlayerData.CharacterObject:
                ...
                {
                    if((WorldServiceLocator.WorldServer.WORLD_CREATUREs[CreatureGUID].aiScript?.aiHateTable.ContainsKey(
                            Target)) ==
                        true)
                    {
                        WorldServiceLocator.WorldServer.WORLD_CREATUREs[CreatureGUID].aiScript
                            .OnGenerateHate(ref Target, Value);
                    }
                }
            ...
            default:
                var target1 = (WS_Creatures.CreatureObject)Target;
                if((target1.aiScript?.aiHateTable.ContainsKey(caster)) == true)
                {
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_MOUNTED(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_NOT_IMPLEMENTED(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(LogType.WARNING, "WARNING: SpellAura [{0}:{1}] is not Implemented.", SpellID, EffectInfo.ID); 
    }
        ...
        AuraAction Action)
    {
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(
                LogType.DEBUG,
                "[DEBUG] Aura None for spell. [Target:{0} Caster:{1} EffectInfo:{2} SpellID:{3} StackCount:{4} Action:{5}]",
                Target,
                Caster,
                EffectInfo,
                SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_PERIODIC_DAMAGE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        switch(Action)
        {
            ...
            case AuraAction.AURA_UPDATE:
                if(Caster is WS_DynamicObjects.DynamicObject @object)
                {
                    ...
                    Target.DealSpellDamage(
                        ref @object.Caster,
                        ref EffectInfo,
                        SpellID,
                        Damage2,
                        (DamageTypes)checked((byte)SPELLs[SpellID].School),
                        SpellType.SPELL_TYPE_DOT);
                    break;
                }
                int Damage;
                ...
                checked
                {
                    Damage = EffectInfo.GetValue(Level: ((WS_Base.BaseUnit)Caster).Level, ComboPoints: 0) *
                        StackCount;
                    obj = Target;
    ...
    public void SPELL_AURA_PERIODIC_DAMAGE_PERCENT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
            ...
            case AuraAction.AURA_UPDATE:
                ...
                checked
                {
                    ...
                    Damage = (int)Math.Round(
                        Target.Life.Maximum * EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) / 100.0 *
                            StackCount);
                    obj = Target;
                    Caster2 = caster;
                }
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_PERIODIC_DUMMY(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
                ...
                case AuraAction.AURA_REMOVEBYDURATION:
                    if(Caster is WS_PlayerData.CharacterObject characterObject)
                    {
                        switch(SpellID)
                        {
                            ...
                            case 43706:
                            case 46755:
                                WS_Base.BaseUnit caster = characterObject;
                                var Damage2 = EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) * StackCount;
                                var target = (WS_PlayerData.CharacterObject)Target;
                                target.ManaRegenBonus -= Damage2;
                                target.UpdateManaRegen();
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_PERIODIC_ENERGIZE(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_PERIODIC_ENERGIZE_PERCENT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        switch(Action)
        {
            case AuraAction.AURA_UPDATE:
                ...
                checked
                {
                    var caster = (WS_Base.BaseUnit)Caster;
                    Damage = (int)Math.Round(
                        Target.Mana.Maximum * EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0) / 100.0 *
                            StackCount);
                    Caster2 = caster;
                }
                SendPeriodicAuraLog(ref Caster2, ref Target, SpellID, (int)Power, Damage, EffectInfo.ApplyAuraIndex);
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_PERIODIC_HEAL(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_PERIODIC_HEAL_PERCENT(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_PERIODIC_LEECH(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
            ...
            switch(Action)
            {
                ...
                case AuraAction.AURA_UPDATE:
                    ...
                    SendPeriodicAuraLog(
                        ...
                        ref Target,
                        SpellID,
                        SPELLs[SpellID].School,
                        Damage,
                        EffectInfo.ApplyAuraIndex);
                    Caster2 = caster;
                    SendPeriodicAuraLog(
                        ref Target,
                        ref Caster2,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_PERIODIC_MANA_LEECH(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_PERIODIC_TRIGGER_SPELL(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_PROC_TRIGGER_SPELL(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_SAFE_FALL(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_SCHOOL_ABSORB(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        checked
        {
            switch(Action)
            {
                ...
                case AuraAction.AURA_ADD:
                    ...
                    {
                        var caster = (WS_Base.BaseUnit)Caster;
                        Target.AbsorbSpellLeft
                            .Add(
                                SpellID,
                                ((uint)EffectInfo.GetValue(Level: caster.Level, ComboPoints: 0)) +
                                    (((uint)EffectInfo.MiscValue) << 23));
                    }
                    break;
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_SCHOOL_IMMUNITY(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_TRACK_CREATURES(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_TRACK_RESOURCES(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_TRANSFORM(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_WATER_BREATHING(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
    ...
    /// <param name="StackCount"></param>
    /// <param name="Action"></param>
    public void SPELL_AURA_WATER_WALK(
        ref WS_Base.BaseUnit Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect EffectInfo,
        int SpellID,
        ...
        AuraAction Action)
    {
        ...
        switch(Action)
        {
            ...
            case AuraAction.AURA_ADD:
                Packets.Packets.PacketClass packet = new(Opcodes.SMSG_MOVE_WATER_WALK);
                packet.AddPackGUID(Target.GUID);
                Target.SendToNearPlayers(ref packet);
                packet.Dispose();
                break;
            case AuraAction.AURA_REMOVE:
            case AuraAction.AURA_REMOVEBYDURATION:
                Packets.Packets.PacketClass packet2 = new(Opcodes.SMSG_MOVE_LAND_WALK);
                packet2.AddPackGUID(Target.GUID);
                Target.SendToNearPlayers(ref packet2);
                packet2.Dispose();
                break;
    ...
    public SpellFailedReason SPELL_EFFECT_ADDICTIONAL_DMG(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        if(Infected is null)
        {
            throw new ArgumentNullException(nameof(Infected));
        }

        var Ranged = false;
        const bool Offhand = false;
        ...
        {
            var Unit = (WS_Base.BaseUnit)Infected[i];
            var wS_Combat = WorldServiceLocator.WSCombat;
            var Attacker = (WS_Base.BaseUnit)Caster;
            Caster = Attacker;
            var damageInfo = wS_Combat.CalculateDamage(
                ref Attacker,
                ref Unit,
                Offhand,
                Ranged,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_APPLY_AREA_AURA(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        for(var i = 0; i < Infected.Count; i++)
        {
            var u = (WS_Base.BaseUnit)Infected[i];
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_APPLY_AURA(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        const SpellFailedReason result = SpellFailedReason.SPELL_NO_ERROR;
        ...
        {
            var caster = (WS_Base.BaseUnit)Caster;
            foreach(var dynamic in caster.dynamicObjects.ToArray())
            {
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_BIND(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_BLOCK(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_CHARGE(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        var TimeToMove = checked(Math.Round(moveDist / SPELLs[SpellID].Speed * 1000f));
        ...
        SMSG_MONSTER_MOVE.AddInt32(WorldServiceLocator.NativeMethods.timeGetTime(string.Empty));
        ...
        if(Caster is WS_PlayerData.CharacterObject object1)
        {
            WorldServiceLocator.WSCombat
                .SendAttackStart(
                    attackerGUID: Caster.GUID,
                    victimGUID: Target.unitTarget.GUID,
                    client: object1.client);
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_CREATE_ITEM(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        checked
        {
            ...
            for(var i = 0; i < Infected.Count; i++)
            {
                ...
                if(Unit is WS_PlayerData.CharacterObject @object)
                {
                    ItemObject tmpItem = new(SpellInfo.ItemType, Unit.GUID) { StackCount = Amount };
                    if(!@object.ItemADD(ref tmpItem))
                    {
                        tmpItem.Delete();
                    } else
                    {
                        var unitTarget = (WS_PlayerData.CharacterObject)Target.unitTarget;
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_DETECT(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    public SpellFailedReason SPELL_EFFECT_DISENCHANT(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        return (Caster is not WS_PlayerData.CharacterObject)
            ? SpellFailedReason.SPELL_FAILED_ERROR
            : SpellFailedReason.SPELL_NO_ERROR;
    }
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_DISPEL(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        for(var i = 0; i < Infected.Count; i++)
        {
            ...
            {
                var caster = (WS_Base.BaseUnit)Caster;
                Unit.RemoveAurasByDispellType(
                    SpellInfo.MiscValue,
                    SpellInfo.GetValue(Level: caster.Level, ComboPoints: 0));
            }
        }
        return SpellFailedReason.SPELL_NO_ERROR;
    }
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_DODGE(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_DUAL_WIELD(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    public SpellFailedReason SPELL_EFFECT_DUEL(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        if(implicitTargetA == 25)
        {
            ...
            if(Caster is WS_PlayerData.CharacterObject @object)
            {
                ...
                WS_GameObjects.GameObject tmpGO = new(
                    SpellInfo.MiscValue,
                    Caster.MapID,
                    flagX,
                    flagY,
                ...
                Packets.Packets.PacketClass packet = new(Opcodes.SMSG_DUEL_REQUESTED);
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_DUMMY(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_ENCHANT_HELD_ITEM(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(LogType.DEBUG, "[DEBUG] Enchant duration [{0}]({1})", Duration, SpellInfo.valueBase);
        for(var i = 0; i < Infected.Count; i++)
        {
            var Unit = (WS_Base.BaseUnit)Infected[i];
            if((Unit is WS_PlayerData.CharacterObject @object) &&
                @object.Items.ContainsKey(15) &&
                @object.Items[15].Enchantments.ContainsKey(1) &&
                (@object.Items[15].Enchantments[1].ID == SpellInfo.MiscValue))
            {
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_ENCHANT_ITEM(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        {
            WorldServiceLocator.WorldServer.CHARACTERs[Target.itemTarget.OwnerGUID].SendItemUpdate(
                Target.itemTarget);
            Packets.Packets.PacketClass EnchantLog = new(Opcodes.SMSG_ENCHANTMENTLOG);
            ...
            {
                if(WorldServiceLocator.WorldServer.CHARACTERs[Target.itemTarget.OwnerGUID].tradeInfo.Trader ==
                    WorldServiceLocator.WorldServer.CHARACTERs[Target.itemTarget.OwnerGUID])
                {
                    WorldServiceLocator.WorldServer.CHARACTERs[Target.itemTarget.OwnerGUID].tradeInfo
                        .SendTradeUpdateToTarget();
                } else
                {
                    WorldServiceLocator.WorldServer.CHARACTERs[Target.itemTarget.OwnerGUID].tradeInfo
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_ENCHANT_ITEM_TEMPORARY(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        if(Duration == 0)
        {
            Duration = (SPELLs[SpellID].SpellVisual == 563)
                ? 600
                : ((SPELLs[SpellID].SpellFamilyName == 8)
                    ? 3600
                    : ((SPELLs[SpellID].SpellFamilyName == 11)
                        ? 1800
                        : ((SPELLs[SpellID].SpellVisual == 215)
                            ? 1800
                            : ((SPELLs[SpellID].SpellVisual != 0) ? 3600 : 1800))));
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_ENERGIZE(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_ENERGIZE_PCT(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        for(var i = 0; i < Infected.Count; i++)
        {
            ...
            checked
            {
                ...
                if(SpellInfo.MiscValue == 0)
                {
                    var caster = (WS_Base.BaseUnit)Caster;
                    Damage = (int)Math.Round(
                        SpellInfo.GetValue(Level: caster.Level, ComboPoints: 0) / 100.0 * Unit.Mana.Maximum);
                }
                Caster2 = (WS_Base.BaseUnit)Caster;
                SendEnergizeSpellLog(ref Caster2, ref Target.unitTarget, SpellID, Damage, SpellInfo.MiscValue);
                Caster = Caster2;
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_ENVIRONMENTAL_DAMAGE(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    public SpellFailedReason SPELL_EFFECT_EVADE(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_HEAL(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        if(Caster is WS_PlayerData.CharacterObject)
        {
            WorldServiceLocator.WorldServer.Log
                .WriteLine(
                    LogType.INFORMATION,
                    "[MapID:{0} X:{1} Y:{2} Z:{3}] SPELL_EFFECT_HEAL [Caster = CharacterObject: {4}]",
                    Caster.MapID,
                    Caster.positionX,
                    Caster.positionY,
                    Caster.positionZ,
                    Caster is WS_PlayerData.CharacterObject);
        } else
        if(Caster is not WS_PlayerData.CharacterObject)
        {
            WorldServiceLocator.WorldServer.Log
                .WriteLine(
                    ...
                    Caster.positionY,
                    Caster.positionZ,
                    Caster is not WS_PlayerData.CharacterObject);
            return SpellFailedReason.SPELL_FAILED_ERROR;
        }
        for(var i = 0; i < Infected.Count; i++)
        {
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_HEAL_MAX_HEALTH(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_HONOR(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_INSTAKILL(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_INTERRUPT_CAST(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        for(var i = 0; i < Infected.Count; i++)
        {
            ...
            {
                case WS_PlayerData.CharacterObject:
                    var unit = (WS_PlayerData.CharacterObject)Unit;
                ...
                case WS_Creatures.CreatureObject:
                    var unit1 = (WS_Creatures.CreatureObject)Unit;
                    unit1.StopCasting();
                    break;
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_KNOCK_BACK(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        {
            var Unit = (WS_Base.BaseUnit)Infected[i];
            var Direction = WorldServiceLocator.WSCombat
                .GetOrientation(Caster.positionX, Unit.positionX, Caster.positionY, Unit.positionY);
            Packets.Packets.PacketClass packet = new(Opcodes.SMSG_MOVE_KNOCK_BACK);
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_LEAP(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        float hitY = default;
        float hitZ = default;
        if(WorldServiceLocator.WSMaps
            .GetObjectHitPos(ref Caster, selectedX, selectedY, selectedZ + 2f, ref hitX, ref hitY, ref hitZ, -1f))
        {
            selectedX = hitX;
            selectedY = hitY;
            selectedZ = hitZ + 0.2f;
        ...
        switch(Caster)
        {
            ...
            default:
                var caster1 = (WS_Creatures.CreatureObject)Caster;
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_LEARN_SPELL(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_MANA_DRAIN(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        checked
        {
            ...
            for(var i = 0; i < Infected.Count; i++)
            {
                ...
                switch(SpellInfo.MiscValue)
                {
                    ...
                    case 1:
                        if((Unit is WS_PlayerData.CharacterObject object1) &&
                            (Caster is WS_PlayerData.CharacterObject object2))
                        {
                    ...
                    case 3:
                        if((Unit is WS_PlayerData.CharacterObject object3) &&
                            (Caster is WS_PlayerData.CharacterObject object4))
                        {
                ...
                {
                    case WS_Creatures.CreatureObject:
                        Packets.Packets.UpdateClass myTmpUpdate = new(188);
                        myTmpUpdate.SetUpdateFlag(23 + SpellInfo.MiscValue, TargetPower);
                        Packets.Packets.UpdatePacketClass myPacket = new();
                        Packets.Packets.PacketClass packet = myPacket;
                        ...
                        myPacket = (Packets.Packets.UpdatePacketClass)packet;
                        packet = myPacket;
                        Unit.SendToNearPlayers(ref packet);
                        myPacket = (Packets.Packets.UpdatePacketClass)packet;
                        myPacket.Dispose();
            ...
            switch(Caster)
            {
                case WS_Creatures.CreatureObject:
                    ...
                    Packets.Packets.PacketClass packet = Packet;
                    ...
                    Packet = (Packets.Packets.UpdatePacketClass)packet;
                ...
                case WS_PlayerData.CharacterObject:
                    var caster2 = (WS_PlayerData.CharacterObject)Caster;
    ...
    /// <param name="Infected"></param>
    /// <param name="Item"></param>
    /// <returns>Display warning for unimplemented spell effects</returns>
    public SpellFailedReason SPELL_EFFECT_NOT_IMPLEMENTED(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(LogType.WARNING, "WARNING: SpellID [{0}:{1}] is not Implemented.", SpellID, SpellInfo.ID);
        return SpellFailedReason.SPELL_FAILED_ERROR;
    }
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_NOTHING(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_OPEN_LOCK(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        if(Target.goTarget != null)
        {
            ...
            var goTarget = (WS_GameObjects.GameObject)Target.goTarget;
        ...
        if(lockID == 0)
        {
            if(WorldServiceLocator.CommonGlobalFunctions.GuidIsGameObject(targetGUID) &&
                WorldServiceLocator.WorldServer.WORLD_GAMEOBJECTs.ContainsKey(targetGUID))
            {
        ...
        {
            WorldServiceLocator.WorldServer.Log
                .WriteLine(LogType.WARNING, "[DEBUG] Lock {0} did not exist.", lockID);
            return SpellFailedReason.SPELL_FAILED_ERROR;
        }
        byte i = 0;
        do
        {
            if((Item != null) &&
                (WorldServiceLocator.WSLoot.Locks[lockID].KeyType[i] == 1) &&
                (WorldServiceLocator.WSLoot.Locks[lockID].Keys[i] == Item.ItemEntry))
            {
                if(WorldServiceLocator.CommonGlobalFunctions.GuidIsGameObject(targetGUID) &&
                    WorldServiceLocator.WorldServer.WORLD_GAMEOBJECTs.ContainsKey(targetGUID))
                {
                    var Character = (WS_PlayerData.CharacterObject)Caster;
                    WorldServiceLocator.WorldServer.WORLD_GAMEOBJECTs[targetGUID].LootObject(
                        ref Character,
                        LootType);
                }
                return SpellFailedReason.SPELL_NO_ERROR;
        ...
        var SkillID = 0;
        if((SPELLs[SpellID].SpellEffects[1]?.ID) == SpellEffects_Names.SPELL_EFFECT_SKILL)
        {
            SkillID = SPELLs[SpellID].SpellEffects[1].MiscValue;
        } else if((SPELLs[SpellID].SpellEffects[0]?.MiscValue) == 1)
        {
            SkillID = 633;
        }
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_PARRY(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_PERSISTENT_AREA_AURA(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        WS_DynamicObjects.DynamicObject dynamicObject = new(
            ref Caster_,
            SpellID,
            Target.dstX,
            Target.dstY,
            Target.dstZ,
            SPELLs[SpellID].GetDuration,
            SpellInfo.GetRadius);
        Caster = Caster_;
    ...
    public SpellFailedReason SPELL_EFFECT_PICKPOCKET(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        {
            var caster = (WS_Base.BaseUnit)Caster;
            if((Target.unitTarget is WS_Creatures.CreatureObject @object) &&
                !caster.IsFriendlyTo(ref Target.unitTarget))
            {
                    ...
                    if(!creatureObject.IsDead)
                    {
                        ...
                        if(chance > WorldServiceLocator.WorldServer.Rnd.Next(0, 20))
                        {
                            if(creatureObject.CreatureInfo.PocketLootID > 0)
                            {
                                ...
                                WorldServiceLocator.WSLoot.LootTemplates_Pickpocketing
                                .GetLoot(creatureObject.CreatureInfo.PocketLootID)?.Process(ref Loot, 0);
                                var caster1 = (WS_PlayerData.CharacterObject)Caster;
                            ...
                            {
                                var caster1 = (WS_PlayerData.CharacterObject)Caster;
                                WorldServiceLocator.WSLoot
                                    .SendEmptyLoot(
                                        creatureObject.GUID,
                                        LootType.LOOTTYPE_PICKPOCKETING,
                                        ref caster1.client);
                            }
                        } else
                        {
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_PROFICIENCY(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_QUEST_COMPLETE(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_RESURRECT(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        {
            var unit = (WS_Corpses.CorpseObject)Unit;
            switch(Unit)
            {
                case WS_PlayerData.CharacterObject:
                {
                    var unit1 = (WS_PlayerData.CharacterObject)Unit;
                    if(decimal.Compare(new decimal(unit1.resurrectGUID), 0m) != 0)
                    {
                        if(Caster is WS_PlayerData.CharacterObject @object)
                        {
                            Packets.Packets.PacketClass RessurectFailed = new(Opcodes.SMSG_RESURRECT_FAILED);
                    ...
                    var caster = (WS_Base.BaseUnit)Caster;
                    unit1.resurrectHealth = checked(unit1.Life.Maximum *
                            SpellInfo.GetValue(Level: caster.Level, ComboPoints: 0)) /
                        100;
                    unit1.resurrectMana = checked(unit1.Mana.Maximum * SpellInfo.MiscValue) / 100;
                    Packets.Packets.PacketClass RessurectRequest = new(Opcodes.SMSG_RESURRECT_REQUEST);
                ...
                case WS_Creatures.CreatureObject:
                {
                    var unit2 = (WS_Creatures.CreatureObject)Unit;
                    var unit1 = unit2;
                    ...
                    UpdateData.Dispose();
                    var unitTarget = (WS_Creatures.CreatureObject)Target.unitTarget;
                    unitTarget.MoveToInstant(
                        Caster.positionX,
                        Caster.positionY,
                        Caster.positionZ,
                        Caster.orientation);
                ...
                case WS_Corpses.CorpseObject when WorldServiceLocator.WorldServer.CHARACTERs.ContainsKey(unit.Owner):
                {
                    ...
                    characterObject.resurrectHealth = checked(characterObject.Life.Maximum * SpellInfo.valueBase) /
                        100;
                    characterObject.resurrectMana = checked(characterObject.Mana.Maximum * SpellInfo.MiscValue) /
                        100;
                    Packets.Packets.PacketClass RessurectRequest = new(Opcodes.SMSG_RESURRECT_REQUEST);
                    RessurectRequest.AddUInt64(Caster.GUID);
                    RessurectRequest.AddUInt32(1u);
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_RESURRECT_NEW(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        foreach(var Unit in Infected)
        {
            var unit1 = (WS_Corpses.CorpseObject)Unit;
            switch(Unit)
            {
                case WS_PlayerData.CharacterObject:
                {
                    ...
                    Packets.Packets.PacketClass RessurectRequest2 = new(Opcodes.SMSG_RESURRECT_REQUEST);
                ...
                case WS_Creatures.CreatureObject:
                {
                    var unit = (WS_Creatures.CreatureObject)Unit;
                    ...
                    UpdateData.AddToPacket(ref packet, ObjectUpdateType.UPDATETYPE_VALUES, ref updateObject);
                    var packet1 = (Packets.Packets.UpdatePacketClass)packet;
                ...
                case WS_Corpses.CorpseObject when WorldServiceLocator.WorldServer.CHARACTERs
                    .ContainsKey(unit1.Owner):
                {
                    var unit = unit1;
                    ...
                    var caster = (WS_Base.BaseUnit)Caster;
                    WorldServiceLocator.WorldServer.CHARACTERs[unit.Owner].resurrectHealth = SpellInfo.GetValue(
                        caster.Level,
                        0);
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_SCHOOL_DAMAGE(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        {
            var caster = (WS_Base.BaseUnit)Caster;
            var Damage = (Caster is not WS_DynamicObjects.DynamicObject @object)
                ? SpellInfo.GetValue(Level: caster.Level, ComboPoints: 0)
                : SpellInfo.GetValue(@object.Caster.Level, 0);
            var Current = 0;
            if(Current > 0)
            {
                Damage = checked((int)Math.Round(Damage * Math.Pow(SpellInfo.DamageMultiplier, Current)));
            ...
            switch(Caster)
            {
                ...
                case WS_DynamicObjects.DynamicObject:
                    var caster1 = (WS_DynamicObjects.DynamicObject)Caster;
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_SCRIPT_EFFECT(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        if(SPELLs[SpellID].SpellFamilyName == 10)
        {
            ...
            {
                if((Target.unitTarget?.IsDead) != false)
                {
                    return SpellFailedReason.SPELL_FAILED_TARGETS_DEAD;
                }
                checked
                {
                    ...
                    {
                        var caster = (WS_Base.BaseUnit)Caster;
                        if(((caster.ActiveSpells[i]?.GetSpellInfo.SpellVisual) == 5622) &&
                            (caster.ActiveSpells[i].GetSpellInfo.SpellFamilyName == 10) &&
                            (caster.ActiveSpells[i].Aura_Info[2] != null))
                        {
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_SKILL_STEP(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_FAILED_BAD_TARGETS</returns>
    public SpellFailedReason SPELL_EFFECT_SKINNING(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        switch(Target.unitTarget)
        {
            case WS_Creatures.CreatureObject:
                ...
                {
                    if(creatureObject.IsDead &&
                        WorldServiceLocator.Functions.HaveFlags(creatureObject.cUnitFlags, 67108864))
                    {
                        ...
                        if(creatureObject.CreatureInfo.SkinLootID > 0)
                        {
                            ...
                            WorldServiceLocator.WSLoot.LootTemplates_Skinning
                            .GetLoot(creatureObject.CreatureInfo.SkinLootID)?.Process(ref Loot, 0);
                            var caster = (WS_PlayerData.CharacterObject)Caster;
                        ...
                        } else
                        {
                            var caster = (WS_PlayerData.CharacterObject)Caster;
                            WorldServiceLocator.WSLoot
                                .SendEmptyLoot(creatureObject.GUID, LootType.LOOTTYPE_SKINNING, ref caster.client);
                        }
                        Packets.Packets.UpdateClass TmpUpdate = new(188);
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_STEALTH(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    public SpellFailedReason SPELL_EFFECT_SUMMON(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Infected"></param>
    /// <param name="Item"></param>
    /// <returns>SPELL_EFFECT_SUMMON_DEMON</returns>
    public SpellFailedReason SPELL_EFFECT_SUMMON_DEMON(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        if(SPELLs[SpellID].GetDuration == 0)
        {
            ...
            WS_Creatures.CreatureObject tmpCreature = new(
                SpellInfo.MiscValue,
                SelectedX,
                SelectedY,
                SelectedZ,
    ...
    /// <param name="Target"></param>
    /// <param name="Caster"></param>
    /// <param name="SpellInfo"></param>S
    /// <param name="SpellID"></param>
    /// <param name="Infected"></param>
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    //public SpellFailedReason SPELL_EFFECT_SUMMON_OBJECT(
    //    ref SpellTargets Target,
    //    ref WS_Base.BaseObject Caster,
    //    ref SpellEffect SpellInfo,
    //    int SpellID,
    ...
    //    }
    //    var GameobjectInfo = WorldServiceLocator.WorldServer.GAMEOBJECTSDatabase.ContainsKey(SpellInfo.MiscValue)
    //        ? WorldServiceLocator.WorldServer.GAMEOBJECTSDatabase[SpellInfo.MiscValue]
    //        : new WS_GameObjects.GameObjectInfo(SpellInfo.MiscValue);
    //    var caster = (WS_Base.BaseUnit)Caster;
    //    var tmpGO = tmpgo;
    //    var tmpgo = (WS_GameObjects.GameObject)tmpGO;
    //    var tmpgo = tmpGO;
    ...
    /// <param name="Infected"></param>
    /// <param name="Item"></param>
    /// <returns>SPELL_EFFECT_SUMMON_PET</returns>
    public SpellFailedReason SPELL_EFFECT_SUMMON_PET(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    public SpellFailedReason SPELL_EFFECT_SUMMON_TOTEM(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
            ...
            switch(SpellInfo.ID)
            {
                ...
                default:
                    ...
                    if(Slot < 4)
                    {
                        ...
                        {
                            WorldServiceLocator.WorldServer.Log
                                .WriteLine(LogType.DEBUG, "[DEBUG] Destroyed old totem.");
                    ...
                    selectedZ = WorldServiceLocator.WSMaps
                        .GetZCoord(selectedX, selectedY, Caster.positionZ, Caster.MapID);
                    WS_Totems.TotemObject NewTotem = new(
                        SpellInfo.MiscValue,
                        selectedX,
                        selectedY,
                        selectedZ,
                    ...
                    NewTotem.InitSpell(
                        WorldServiceLocator.WorldServer.CREATURESDatabase[SpellInfo.MiscValue].Spells[0]);
                    NewTotem.AddToWorld();
                    WorldServiceLocator.WorldServer.Log
                        .WriteLine(LogType.DEBUG, "[DEBUG] Totem spawned by [{0:X}].", NewTotem.GUID);
    ...
    public SpellFailedReason SPELL_EFFECT_SUMMON_WILD(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_TELEPORT_GRAVEYARD(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_TELEPORT_UNITS(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        for(var i = 0; i < Infected.Count; i++)
        {
            ...
            if(Unit is WS_PlayerData.CharacterObject @object)
            {
                ...
                if(SpellID == 8690)
                {
                    characterObject.Teleport(
                        characterObject.bindPoint_positionX,
                        characterObject.bindPoint_positionY,
                        characterObject.bindPoint_positionZ,
                        characterObject.orientation,
                        characterObject.bindPoint_map_id);
                } else if(WorldServiceLocator.WSDBCDatabase.TeleportCoords.ContainsKey(SpellID))
                {
                    ...
                    characterObject.Teleport(
                        WorldServiceLocator.WSDBCDatabase.TeleportCoords[SpellID].PosX,
                        WorldServiceLocator.WSDBCDatabase.TeleportCoords[SpellID].PosY,
                        WorldServiceLocator.WSDBCDatabase.TeleportCoords[SpellID].PosZ,
                        characterObject.orientation,
                        checked(mapID));
                } else
                {
                    WorldServiceLocator.WorldServer.Log
                        .WriteLine(
                            LogType.WARNING,
                            "WARNING: Spell {0} did not have any teleport coordinates.",
                            SpellID);
                    return SpellFailedReason.SPELL_FAILED_UNKNOWN;
                }
            }
    ...
    /// <param name="Item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_TRIGGER_SPELL(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
        ...
        ref ItemObject Item)
    {
        ...
        switch(SpellInfo.TriggerSpell)
        {
            ...
            case 35729:
                ...
                while(i <= b3)
                {
                    ...
                    if((Target.unitTarget.ActiveSpells[i] != null) &&
                        ((SPELLs[Target.unitTarget.ActiveSpells[i].SpellID].School & 1) == 0) &&
                        ((attributes & 0x10000u) != 0))
                    {
        ...
        {
            ThreadPool.QueueUserWorkItem(new CastSpellParameters(ref Target, ref Caster, SpellInfo.TriggerSpell).CastAsync);
            return SpellFailedReason.SPELL_NO_ERROR;
        }
        else
        {
    ...
    /// <returns>SPELL_NO_ERROR</returns>
    /// <param name="SpellID"></param>
    public SpellFailedReason SPELL_EFFECT_WEAPON_DAMAGE(
        ref SpellTargets Target,
        ref WS_Base.BaseObject Caster,
        ref SpellEffect SpellInfo,
        int SpellID,
    ...
    /// <param name="item"></param>
    /// <returns>SPELL_NO_ERROR</returns>
    public SpellFailedReason SPELL_EFFECT_WEAPON_DAMAGE_NOSCHOOL(
        ref SpellTargets target,
        ref WS_Base.BaseObject caster,
        ref SpellEffect spellInfo,
        int spellId,
        ...
        ref ItemObject item)
    {
        ...
        for(var i = 0; i < infected.Count; i++)
        {
            ...
            if((caster is WS_PlayerData.CharacterObject character) &&
                (unit is WS_Base.BaseObject victim) &&
                (caster is WS_Base.BaseUnit casterUnit))
            {
                character.attackState
                    .DoMeleeDamageBySpell(
                        ref character,
                        ref victim,
                        spellInfo.GetValue(casterUnit.Level, 0),
                        spellId);
            }
        }
    ...
    public class SpellInfo
    {
        ...
        public int RequiredCasterStance;
        ...
        /// <returns></returns>
        public Dictionary<WS_Base.BaseObject, SpellMissInfo> CalculateMisses(
            ref WS_Base.BaseObject Caster,
            ref List<WS_Base.BaseObject> Targets,
            ref SpellEffect SpellEffect)
        {
            if(Caster is null)
            {
                throw new ArgumentNullException(nameof(Caster));
            ...
            foreach(var Target in Targets)
            {
                ...
                {
                    var baseUnit = unit1;
                    if((SpellEffect.Mechanic > 0) &&
                        ((baseUnit.MechanicImmunity & (1 << checked(SpellEffect.Mechanic - 1))) != 0))
                    {
                    ...
                    } else if((Caster is not WS_PlayerData.CharacterObject object4) || !object4.GM)
                    {
                        switch(DamageType)
                        {
                            ...
                            case 1:
                            {
                                ...
                                var Caster2 = unit;
                                var meleeSpellHitResult = baseUnit3.GetMagicSpellHitResult(
                                    ref Caster2,
                                    this,
                                    WorldServiceLocator.WorldServer.Rnd.Next(0, 10001));
                                Caster = Caster2;
                            ...
                            case 3:
                            {
                                ...
                                var Caster2 = unit;
                                var meleeSpellHitResult = baseUnit2.GetMeleeSpellHitResult(
                                    ref Caster2,
                                    this,
                                    WorldServiceLocator.WorldServer.Rnd.Next(0, 10001));
                                Caster = Caster2;
        ...
        /// <returns></returns>
        public SpellFailedReason CanCast(
            ...
            bool FirstCheck)
        {
            ...
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.WARNING, "WS_Spells:CanCast Null Character Object");
                return SpellFailedReason.SPELL_FAILED_ERROR;
            }
            if(Targets == null)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.WARNING, "WS_Spells:CanCast Null Target Object");
                return SpellFailedReason.SPELL_FAILED_ERROR;
            }
            if (Character?.Spell_Silenced == true)
            {
            ...
            if((Targets.unitTarget != null) &&
                (Targets.unitTarget != Character) &&
                (Targets.unitTarget is WS_PlayerData.CharacterObject @object) &&
                @object.GM)
            {
                return SpellFailedReason.SPELL_FAILED_BAD_TARGETS;
            }
            ...
            if((StanceMask & RequiredCasterStance) == 0)
            {
                ...
                if(actAsShifted)
                {
                    ...
                    if(RequiredCasterStance != 0)
                    {
                        return SpellFailedReason.SPELL_FAILED_ONLY_SHAPESHIFT;
                    }
                } else if(((AttributesEx2 & 0x80000) == 0) && (RequiredCasterStance != 0))
                {
                    return SpellFailedReason.SPELL_FAILED_ONLY_SHAPESHIFT;
                }
            }
            if((((uint)Attributes) &
                    0x20000u &
                    (0u - ((Character.Invisibility != InvisibilityLevel.STEALTH) ? 1u : 0u))) !=
                0)
            {
                return SpellFailedReason.SPELL_FAILED_ONLY_STEALTHED;
            }
            if(((Character.charMovementFlags & WorldServiceLocator.GlobalConstants.movementFlagsMask) != 0) &&
                (((Character.charMovementFlags & 0x4000) == 0) ||
                    (SpellEffects[0].ID != SpellEffects_Names.SPELL_EFFECT_STUCK)) &&
                (IsAutoRepeat || ((((uint)auraInterruptFlags) & 0x40000u) != 0)))
            {
            ...
            if(!FirstCheck &&
                ...
                ((Targets.unitTarget.MechanicImmunity & (1 << checked(Mechanic - 1))) != 0))
            {
                ...
                do
                {
                    if((EquippedItemSubClass & (1 << i)) != 0)
                    {
                        ...
                        switch(i)
                        {
                            ...
                            case 17:
                            case 20:
                                if(Character.Items.ContainsKey(15) &&
                                    !Character.Items[15].IsBroken() &&
                                    (objectClass == EquippedItemClass))
                                {
                                    FoundItem = true;
                                    break;
                                }
                            ...
                            case 15:
                                ...
                                if(Character.Items.ContainsKey(16) &&
                                    !Character.Items[16].IsBroken() &&
                                    (objectClass1 == EquippedItemClass))
                                {
                                    FoundItem = true;
                                    break;
                                }
                            ...
                            case 18:
                            case 19:
                                if(Character.Items.ContainsKey(17) &&
                                    !Character.Items[17].IsBroken() &&
                                    (((int)Character.Items[17].ItemInfo.ObjectClass) == EquippedItemClass))
                                {
                                    switch(i)
                                    {
                                        case 2 or 18 or 3:
                    ...
                    if(SpellEffects[j] != null)
                    {
                        switch(SpellEffects[j].ID)
                        {
                            case SpellEffects_Names.SPELL_EFFECT_DUMMY:
                                if((ID == 1648) &&
                                    ((Targets.unitTarget == null) ||
                                        (Targets.unitTarget.Life.Current > (Targets.unitTarget.Life.Maximum * 0.2))))
                                {
                                    return SpellFailedReason.SPELL_FAILED_BAD_TARGETS;
                                }
                                break;
                            ...
                            case SpellEffects_Names.SPELL_EFFECT_SUMMON_OBJECT:
                                if(SpellEffects[j].MiscValue == 35591)
                                {
                                    ...
                                    {
                                        selectedX = (float)(Character.positionX +
                                            (Math.Cos(Character.orientation) * SpellEffects[j].GetRadius));
                                        selectedY = (float)(Character.positionY +
                                            (Math.Sin(Character.orientation) * SpellEffects[j].GetRadius));
                                    } else
                                    {
                                        selectedX = (float)(Character.positionX +
                                            (Math.Cos(Character.orientation) * GetRange));
                                        selectedY = (float)(Character.positionY +
                                            (Math.Sin(Character.orientation) * GetRange));
                                    }
                                    if(WorldServiceLocator.WSMaps.GetZCoord(selectedX, selectedY, Character.MapID) >
                                        WorldServiceLocator.WSMaps
                                            .GetWaterLevel(selectedX, selectedY, (int)Character.MapID))
                                    {
        ...
        public async Task CastAsync(CastSpellParameters castParams)
        {
            try
            {
                ...
                Packets.Packets.PacketClass spellStart = new(Opcodes.SMSG_SPELL_START);
                ...
                do
                {
                    if((SpellEffects[k]?.ID) == SpellEffects_Names.SPELL_EFFECT_SCHOOL_DAMAGE)
                    {
                        NeedSpellLog = false;
                    }
                    checked
                ...
                if(Speed > 0f)
                {
                    ...
                    if(((((uint)Targets.targetMask) & 0x40u) != 0) &&
                        ((Targets.dstX != 0f) || (Targets.dstY != 0f) || (Targets.dstZ != 0f)))
                    {
                        SpellDistance = WorldServiceLocator.WSCombat
                            .GetDistance(Caster, Targets.dstX, Targets.dstY, Targets.dstZ);
                    }
                ...
                if((!castParams.InstantCast || (GetCastTime == 0)) &&
                    (Caster is WS_PlayerData.CharacterObject object1))
                {
                ...
                if((((attributes & 4u) != 0) || ((attributes & 0x400u) != 0)) &&
                    (Caster is WS_PlayerData.CharacterObject object2))
                {
                    if(object2.attackState.combatNextAttackSpell)
                    {
                        WorldServiceLocator.WSSpells
                            .SendCastResult(
                                SpellFailedReason.SPELL_FAILED_SPELL_IN_PROGRESS,
                                ref object2.client,
                                ID);
                        castParams.Dispose();
                        return;
                ...
                checked
                {
                    if(Caster is WS_PlayerData.CharacterObject Character)
                    {
                        ...
                        switch(powerType)
                        {
                            ...
                            case 1:
                                ...
                                {
                                    characterObject.Rage.Current -= GetManaCost(
                                        characterObject.Level,
                                        characterObject.Rage.Base);
                                }
                                characterObject.SetUpdateFlag(24, characterObject.Rage.Current);
                                characterObject.GroupUpdateFlag |= 16u;
                                characterObject.SendCharacterUpdate();
                            ...
                            case -2:
                                ...
                                {
                                    characterObject.Life.Current -= GetManaCost(
                                        characterObject.Level,
                                        characterObject.Life.Base);
                                }
                            ...
                            case 3:
                                ...
                                {
                                    characterObject.Energy.Current -= GetManaCost(
                                        characterObject.Level,
                                        characterObject.Energy.Base);
                                }
                                characterObject.SetUpdateFlag(26, characterObject.Energy.Current);
                                characterObject.GroupUpdateFlag |= 16u;
                                characterObject.SendCharacterUpdate();
                        ...
                        {
                            Character = (WS_PlayerData.CharacterObject)Caster;
                            var gameObject = (WS_GameObjects.GameObject)Targets.goTarget;
                    ...
                    } else if(Caster is WS_Creatures.CreatureObject creatureObject)
                    {
                        switch(powerType)
                        {
                            case 0:
                            {
                                creatureObject.Mana.Current -= GetManaCost(
                                    creatureObject.Level,
                                    creatureObject.Mana.Base);
                                Packets.Packets.UpdateClass powerUpdate2 = new(
                                    WorldServiceLocator.GlobalConstants.FIELD_MASK_SIZE_PLAYER);
                                powerUpdate2.SetUpdateFlag(23, creatureObject.Mana.Current);
                                Packets.Packets.UpdatePacketClass updatePacket2 = new();
                                Packets.Packets.PacketClass packet = updatePacket2;
                                var creature = (WS_Creatures.CreatureObject)Caster;
                                powerUpdate2.AddToPacket(
                                    ref packet,
                                    ObjectUpdateType.UPDATETYPE_VALUES,
                                    ref creature);
                                updatePacket2 = (Packets.Packets.UpdatePacketClass)packet;
                            ...
                            case -2:
                            {
                                creatureObject.Life.Current -= GetManaCost(
                                    creatureObject.Level,
                                    creatureObject.Life.Base);
                                Packets.Packets.UpdateClass powerUpdate = new(
                                    WorldServiceLocator.GlobalConstants.FIELD_MASK_SIZE_PLAYER);
                                powerUpdate.SetUpdateFlag(22, creatureObject.Life.Current);
                                Packets.Packets.UpdatePacketClass updatePacket = new();
                                Packets.Packets.PacketClass packet = updatePacket;
                                var creature = (WS_Creatures.CreatureObject)Caster;
                                powerUpdate.AddToPacket(
                                    ref packet,
                                    ObjectUpdateType.UPDATETYPE_VALUES,
                                    ref creature);
                                updatePacket = (Packets.Packets.UpdatePacketClass)packet;
                                packet = updatePacket;
                    ...
                    if((Caster is WS_PlayerData.CharacterObject object5) && (castParams.Item != null))
                    {
                        ...
                        if(castParams.Item.ItemInfo.ObjectClass == ITEM_CLASS.ITEM_CLASS_CONSUMABLE)
                        {
                            ...
                            if(castParams.Item.StackCount <= 0)
                            {
                                ...
                                if((bag != WorldServiceLocator.GlobalConstants.ITEM_SLOT_NULL) &&
                                    (slot != WorldServiceLocator.GlobalConstants.ITEM_SLOT_NULL))
                                {
                ...
                do
                {
                    ...
                    {
                        WorldServiceLocator.WorldServer.Log
                            .WriteLine(LogType.DEBUG, "DEBUG: Casting effect: {0}", SpellEffects[i].ID);
                        var iD = (int)SpellEffects[i].ID;
                        SpellCastError = WorldServiceLocator.WSSpells.SPELL_EFFECTs[iD](
                            ref Targets,
                            ref Caster,
                            ref SpellEffects[i],
                            ID,
            ...
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "Error when casting spell. {0}", $"{Environment.NewLine}{e}");
            }
            if(castParams != null)
            {
                try
                ...
                } catch(Exception ex)
                {
                    WorldServiceLocator.WorldServer.Log
                        .WriteLine(
                            LogType.FAILED,
                            "Unable to dispose of castParams. {0}:{1}",
                            castParams,
                            $"{Environment.NewLine}{ex}");
                }
            }
        ...
        public int GetManaCost(int level, int Mana)
        {
            return checked((int)Math.Round(
                manaCost + (manaCostPerLevel * level) + (Mana * (manaCostPercent / 100.0))));
        }
        ...
        /// <returns></returns>
        public Dictionary<WS_Base.BaseObject, SpellMissInfo> GetTargets(
            ref WS_Base.BaseObject Caster,
            SpellTargets Targets,
            byte Index)
        {
            ...
            if(Caster is WS_Totems.TotemObject @object)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(
                        LogType.INFORMATION,
                        "[MapID:{0} X:{1} Y:{2} Z:{3}] Totem GetTargets [Caster = TotemObject: {4}]",
                        Caster.MapID,
                        Caster.positionX,
                        Caster.positionY,
                        Caster.positionZ,
                        Caster is WS_Totems.TotemObject);
                Ref = @object.Caster;
            }
            if(SpellEffects[Index] != null)
            {
                ...
                do
                {
                    ...
                    var ImplicitTarget = (SpellImplicitTargets)checked(implicitTargetA);
                    if(i == 1)
                    {
                    ...
                    WorldServiceLocator.WorldServer.Log
                        .WriteLine(
                            LogType.DEBUG,
                            "{0}: {1}",
                            Conversions.ToString(Interaction.IIf(i == 1, "ImplicitTargetB", "ImplicitTargetA")),
                            ImplicitTarget);
                    checked
                    {
                        switch(ImplicitTarget)
                        {
                            ...
                            case SpellImplicitTargets.TARGET_ALL_ENEMY_IN_AREA_INSTANT:
                                ...
                                if((unchecked(targetMask) & 0x40u) != 0)
                                {
                                    ...
                                    EnemyTargets2 = wS_Spells6.GetEnemyAtPoint(
                                        ref objCharacter,
                                        Targets.dstX,
                                        Targets.dstY,
                                        Targets.dstZ,
                                        SpellEffects[Index].GetRadius);
                                } else if(Caster is WS_DynamicObjects.DynamicObject object1)
                                {
                                    EnemyTargets2 = WorldServiceLocator.WSSpells
                                        .GetEnemyAtPoint(
                                            ref object1.Caster,
                                            Caster.positionX,
                                            Caster.positionY,
                                ...
                                } else
                                {
                                    ...
                                    EnemyTargets2 = wS_Spells7.GetEnemyAtPoint(
                                        ref objCharacter,
                                        Caster.positionX,
                                        Caster.positionY,
                                        Caster.positionZ,
                            ...
                            case SpellImplicitTargets.TARGET_ALL_FRIENDLY_UNITS_AROUND_CASTER:
                            {
                                ...
                                var array = wS_Spells5.GetEnemyAroundMe(
                                    ref objCharacter,
                                    SpellEffects[Index].GetRadius,
                                    Ref);
                                foreach(var EnemyTarget5 in array)
                                {
                            ...
                            case SpellImplicitTargets.TARGET_ALL_PARTY:
                            {
                                ...
                                foreach(var PartyTarget2 in wS_Spells10.GetPartyMembersAroundMe(ref objCharacter2, 9999999f))
                                {
                            ...
                            case SpellImplicitTargets.TARGET_AREAEFFECT_PARTY:
                                ...
                                switch(Caster)
                                {
                                    case WS_Totems.TotemObject object2:
                                    {
                                        ...
                                        PartyTargets = wS_Spells8.GetPartyMembersAtPoint(
                                            ref objCharacter2,
                                            SpellEffects[Index].GetRadius,
                                            Caster.positionX,
                                            Caster.positionY,
                                    ...
                                    default:
                                    {
                                        ...
                                        PartyTargets = wS_Spells9.GetPartyMembersAroundMe(
                                            ref objCharacter2,
                                            SpellEffects[Index].GetRadius);
                                        break;
                                    }
                            ...
                            case SpellImplicitTargets.TARGET_CHAIN_HEAL:
                                ...
                                while(j <= ((uint)b))
                                {
                                    ...
                                    var EnemyTargets = wS_Spells2.GetEnemyAroundMe(
                                        ref TargetUnit,
                                        10f,
                                        objCharacter);
                                    TargetUnit = null;
                                    foreach(var tmpUnit in EnemyTargets)
                                    {
                                        ...
                                        {
                                            var TmpLife = (float)(tmpUnit.Life.Current /
                                                ((double)tmpUnit.Life.Maximum));
                                            var LowHealth = 1.01f;
                            ...
                            case SpellImplicitTargets.TARGET_AROUND_CASTER_ENEMY:
                            {
                                ...
                                var array = wS_Spells.GetEnemyAroundMe(
                                    ref objCharacter,
                                    SpellEffects[Index].GetRadius,
                                    Ref);
                                foreach(var EnemyTarget2 in array)
                                {
                            ...
                            case SpellImplicitTargets.TARGET_INFRONT:
                                if((CustomAttributes & (true ? 1u : 0u)) != 0)
                                {
                                    var objCharacter = (WS_Base.BaseUnit)Caster;
                                    Caster = objCharacter;
                                    var wS_Spells3 = WorldServiceLocator.WSSpells;
                                    var array = wS_Spells3.GetEnemyInBehindMe(
                                        ref objCharacter,
                                        SpellEffects[Index].GetRadius);
                                    foreach(var EnemyTarget4 in array)
                                    {
                                ...
                                } else
                                {
                                    ...
                                    var array = wS_Spells4.GetEnemyInFrontOfMe(
                                        ref objCharacter,
                                        SpellEffects[Index].GetRadius);
                                    foreach(var EnemyTarget3 in array)
                                    {
                            ...
                            case SpellImplicitTargets.TARGET_NONCOMBAT_PET:
                                if((Caster is WS_PlayerData.CharacterObject object3) &&
                                    (object3.NonCombatPet != null))
                                {
                ...
                if((SpellEffects[Index].implicitTargetA == 0) &&
                    (SpellEffects[Index].implicitTargetB == 0) &&
                    (TargetsInfected.Count == 0))
                {
                    if(Targets.unitTarget != null)
                    {
                        if(!TargetsInfected.Contains(Targets.unitTarget))
        ...
        public void InitCustomAttributes()
        {
            ...
            do
            {
                if(SpellEffects[j] != null)
                {
                    switch(SpellEffects[j].ApplyAuraIndex)
                    {
                        ...
                        case 26:
                            CustomAttributes = CustomAttributes | 0x20u | 0x2000u;
                            break;

                        case 33:
                            CustomAttributes |= 8192u;
                            break;
            ...
            do
            {
                if(SpellEffects[k] != null)
                {
                    ...
                    {
                        CustomAttributes = (CustomAttributes | 0x20u) & 0xFFFFDFFFu;
                    }
                }
                k = checked(k + 1);
            } while (k <= 2);
        ...
        public void SendInterrupted(byte result, ref WS_Base.BaseUnit Caster)
        {
            ...
            if(Caster is WS_PlayerData.CharacterObject @object)
            {
                Packets.Packets.PacketClass packet = new(Opcodes.SMSG_SPELL_FAILURE);
                packet.AddUInt64(Caster.GUID);
                packet.AddInt32(ID);
            ...
            Packets.Packets.PacketClass packet2 = new(Opcodes.SMSG_SPELL_FAILED_OTHER);
        ...
        public void SendSpellCoolDown(ref WS_PlayerData.CharacterObject objCharacter, ItemObject castItem = null)
        {
            ...
            checked
            {
                ...
                objCharacter.Spells[ID].CoolDown = (uint)(WorldServiceLocator.Functions.GetTimestamp(DateTime.Now) +
                    (Recovery / 1000));
                if(castItem != null)
                {
                ...
                if(Recovery > 10000)
                {
                    WorldServiceLocator.WorldServer.CharacterDatabase
                        .Update(
                            $"UPDATE characters_spells SET cooldown={objCharacter.Spells[ID].CoolDown}, cooldownitem={objCharacter.Spells[ID].CoolDownItem} WHERE guid = {objCharacter.GUID} AND spellid = {ID};");
                }
                Packets.Packets.PacketClass packet = new(Opcodes.SMSG_SPELL_COOLDOWN);
                ...
                if(castItem != null)
                {
                    packet = new Packets.Packets.PacketClass(Opcodes.SMSG_ITEM_COOLDOWN);
        ...
        public void SendSpellGO(
            ref WS_Base.BaseObject Caster,
            ref SpellTargets Targets,
            ref Dictionary<ulong, SpellMissInfo> InfectedTargets,
            ref ItemObject Item)
        {
            if(Caster is null)
            {
            ...
            if(InfectedTargets is null)
            {
                throw new ArgumentNullException(nameof(InfectedTargets));
            }

            short castFlags = 256;
            Packets.Packets.PacketClass packet;
            checked
            {
                if(IsRanged)
                {
                ...
                packet = new Packets.Packets.PacketClass(Opcodes.SMSG_SPELL_GO);
                if(Item != null)
                {
        ...
        public void SendSpellLog(ref WS_Base.BaseObject Caster, ref SpellTargets Targets)
        {
            ...
            Packets.Packets.PacketClass packet = new(Opcodes.SMSG_SPELLLOGEXECUTE);
            if(Caster is WS_PlayerData.CharacterObject)
            {
                packet.AddPackGUID(Caster.GUID);
            ...
            const int num = checked(numOfSpellEffects - 1);
            ...
            SpellMissInfo MissInfo)
        {
            ...
            Packets.Packets.PacketClass packet = new(Opcodes.SMSG_SPELLLOGMISS);
            packet.AddInt32(ID);
            packet.AddUInt64(Caster.GUID);
            packet.AddInt8(0);
            packet.AddInt32(1);
        ...
        public void StartChannel(ref WS_Base.BaseUnit Caster, int Duration, ref SpellTargets Targets)
        {
            ...
            {
                case WS_PlayerData.CharacterObject:
                    Packets.Packets.PacketClass packet = new(Opcodes.MSG_CHANNEL_START);
                    packet.AddInt32(ID);
            ...
            Packets.Packets.UpdatePacketClass updatePacket = new();
            Packets.Packets.UpdateClass updateBlock = new(
                WorldServiceLocator.GlobalConstants.FIELD_MASK_SIZE_PLAYER);
            ...
            Packets.Packets.PacketClass packet2;
            if(Caster is WS_Creatures.CreatureObject creatureObject)
            {
                packet2 = updatePacket;
                var updateObject = (WS_Creatures.CreatureObject)creatureObject;
                updateBlock.AddToPacket(ref packet2, ObjectUpdateType.UPDATETYPE_VALUES, ref updateObject);
                updatePacket = (Packets.Packets.UpdatePacketClass)packet2;
        ...
        /// <param name="Packet"></param>
        /// <param name="Caster"></param>
        public void WriteAmmoToPacket(ref Packets.Packets.PacketClass Packet, ref WS_Base.BaseUnit Caster)
        {
            if(Packet is null)
            {
                throw new ArgumentNullException(nameof(Packet));
            ...
            if(Caster is WS_PlayerData.CharacterObject characterObject)
            {
                ...
                if(RangedItem != null)
                {
                    ...
                    } else if((characterObject.AmmoID != 0) &&
                        WorldServiceLocator.WorldServer.ITEMDatabase.ContainsKey(characterObject.AmmoID))
                    {
        ...
        public bool CanStackSpellRank
        {
            get
            {
                if(!WorldServiceLocator.WSSpells.SpellChains.ContainsKey(ID) ||
                    (WorldServiceLocator.WSSpells.SpellChains[ID] == 0))
                {
                    return true;
                }
                if(powerType == 0)
        ...
        public bool IsAOE
        {
            get
            {
                if((SpellEffects[0]?.IsAOE) == true)
                {
                    return true;
                }
                if((SpellEffects[1]?.IsAOE) == true)
                {
                    return true;
                }
                return (SpellEffects[2]?.IsAOE) == true;
            }
        }
        ...
        public bool IsDispell
        {
            get
            {
                if((SpellEffects[0]?.ID) == SpellEffects_Names.SPELL_EFFECT_DISPEL)
                {
                    return true;
                }
                if((SpellEffects[1]?.ID) == SpellEffects_Names.SPELL_EFFECT_DISPEL)
                {
                    return true;
                }
                return (SpellEffects[2]?.ID) == SpellEffects_Names.SPELL_EFFECT_DISPEL;
            }
        }
        ...
        public bool IsNegative
        {
            get
            {
                ...
                do
                {
                    if((SpellEffects[i]?.IsNegative) == true)
                    {
                        return true;
                    }
                    checked
    ...
    public class SpellEffect
    {
        ...
        public int GetValue(int Level, int ComboPoints)
        {
            checked
            {
                try
                {
                    return valueBase +
                        (Level * valuePerLevel) +
                        (ComboPoints * valuePerComboPoint) +
                        WorldServiceLocator.WorldServer.Rnd
                            .Next(1, (int)Math.Round(valueDie + (Level * dicePerLevel)));
                } catch(Exception ex)
                {
                    WorldServiceLocator.WorldServer.Log
                        .WriteLine(
                            LogType.WARNING,
                            "GetValue returned an Exception:{0}, valueBase:{1}",
                            ex,
                            valueBase);
        ...
        public bool IsNegative
        {
            get
            {
                ...
                return ApplyAuraIndex switch
                {
                    5 or 7 or 33 or 95 or 2 or 3 or 25 or 60 or 12 or 26 or 27 or 128 or 43 or 53 or 64 or 89 or 56 or 81 or 153 or 162 => true,
                    13 or 29 or 80 or 137 => valueBase < 0,
                    _ => false,
                };
            }
        }
    ...
    public class SpellTargets
    {
        ...
        /// <param name="packet"></param>
        /// <param name="Caster"></param>
        public void ReadTargets(ref Packets.Packets.PacketClass packet, ref WS_Base.BaseObject Caster)
        {
            if(packet is null)
            {
                throw new ArgumentNullException(nameof(packet));
            ...
            if((targetMask1 & 2u) != 0)
            {
                ...
                if(WorldServiceLocator.CommonGlobalFunctions.GuidIsCreature(GUID) ||
                    WorldServiceLocator.CommonGlobalFunctions.GuidIsPet(GUID))
                {
        ...
        /// </summary>
        /// <param name="i"></param>
        public void SetTarget_ITEM(ref ItemObject itemObject)
        {
            itemTarget = itemObject ?? throw new ArgumentNullException(nameof(itemObject));
            checked
            {
                targetMask += 16;
            }
        ...
        /// </summary>
        /// <param name="o"></param>
        public void SetTarget_OBJECT(ref WS_Base.BaseObject gameObject)
        {
            goTarget = gameObject ?? throw new ArgumentNullException(nameof(gameObject));
            checked
            {
                targetMask += 2048;
            }
        ...
        {
            unitTarget = objCharacter ?? throw new ArgumentNullException(nameof(objCharacter));
            checked
            {
                targetMask += 0;
            }
        ...
        {
            stringTarget = str ?? throw new ArgumentNullException(nameof(str));
            checked
            {
                targetMask += 8192;
            }
        ...
        /// </summary>
        /// <param name="packet"></param>
        public void WriteTargets(ref Packets.Packets.PacketClass packet)
        {
            if(packet is null)
            {
                throw new ArgumentNullException(nameof(packet));
    ...
    public class CastSpellParameters : IDisposable
    {
        ...
        public async void CastAsync(object status)
        {
            try
            {
                Stopped = false;
            ...
            } catch(Exception ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(
                        LogType.WARNING,
                        "Cast Exception {0} : Interrupted {1} : Exception {2}",
                        SpellID,
                        Stopped,
                        ex);
            }
            ...
            checked
            {
                if((Caster != null) && !Finished)
                {
                    ...
                    if((resistChance <= 0) || (resistChance <= WorldServiceLocator.WorldServer.Rnd.Next(0, 100)))
                    {
                        ...
                        Delayed += delaytime;
                        Packets.Packets.PacketClass packet = new(Opcodes.SMSG_SPELL_DELAYED);
                        packet.AddPackGUID(Caster.GUID);
        ...
        public void StopCast()
        {
            ...
            } catch(Exception ex2)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(
                        LogType.WARNING,
                        "StopCast Exception {0} : Interrupted {1} : Exception {2}",
                        SpellID,
                        Stopped,
                        ex2);
            }
        ...
        public bool Finished => Stopped ||
            (State == SpellCastState.SPELL_STATE_FINISHED) ||
            (State == SpellCastState.SPELL_STATE_IDLE);
