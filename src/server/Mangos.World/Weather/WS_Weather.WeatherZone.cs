    ...
    public class WeatherZone
    {
        ...
        public bool ChangeWeather()
        {
            ...
            if(u >= 30)
            {
                ...
                var TimeSince1Jan = checked((int)DateAndTime.Now.Subtract(new DateTime(DateAndTime.Now.Year, 1, 1))
                    .TotalDays);
                ...
                checked
                {
                    ...
                    } else
                    {
                        ...
                        Intensity = (r < 50)
                            ? (((float)(WorldServiceLocator.WorldServer.Rnd.NextDouble() * 0.33329999446868896)) +
                                0.3334f)
                            : (((float)(WorldServiceLocator.WorldServer.Rnd.NextDouble() * 0.33329999446868896)) +
                                0.6667f);
                    }
