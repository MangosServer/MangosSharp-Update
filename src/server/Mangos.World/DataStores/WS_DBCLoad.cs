...
public class WS_DBCLoad
{
    ...
    public WS_DBCLoad(DataStoreProvider dataStoreProvider) => this.dataStoreProvider = dataStoreProvider ?? throw new ArgumentNullException(nameof(dataStoreProvider));
        ...
        checked
        {
            try
            {
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} Areas initialized.", tmpDBC.Rows - 1);
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSDBCDatabase.CharClasses[(byte)classID] = new WS_DBCDatabase.TCharClass(
                        cinematicID);
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} CharClasses initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: ChrClasses is Missing.", ex);
            }
        }
    }
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSDBCDatabase.CharRaces[(byte)raceID] = new WS_DBCDatabase.TCharRace(
                        (short)factionID,
                        modelM,
                        modelF,
                        (byte)teamID,
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} CharRaces initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
    ...
    public async Task InitializeDurabilityCostsAsync()
    {
        checked
        {
            try
            {
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} DurabilityCosts initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: DurabilityCosts is Missing.", ex);
            }
        }
    }
    ...
    public async Task InitializeEmotesAsync()
    {
        checked
        {
            try
            {
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} Emotes initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
    ...
    public async Task InitializeEmotesTextAsync()
    {
        checked
        {
            try
            {
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} EmotesText initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: EmotesText is Missing.", ex);
            }
        }
    }
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSDBCDatabase.FactionInfo[factionID] = new WS_DBCDatabase.TFaction(
                        (short)factionID,
                        (short)factionFlag,
                        flags[0],
                        flags[1],
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} Factions initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSDBCDatabase.FactionTemplatesInfo
                        .Add(templateID, new WS_DBCDatabase.TFactionTemplate());
                    WorldServiceLocator.WSDBCDatabase.FactionTemplatesInfo[templateID].FactionID = tmpDBC.ReadInt(
                        i,
                        1);
                    WorldServiceLocator.WSDBCDatabase.FactionTemplatesInfo[templateID].ourMask = (uint)tmpDBC.ReadInt(
                        i,
                        3);
                    WorldServiceLocator.WSDBCDatabase.FactionTemplatesInfo[templateID].friendMask = (uint)tmpDBC.ReadInt(
                        i,
                        4);
                    WorldServiceLocator.WSDBCDatabase.FactionTemplatesInfo[templateID].enemyMask = (uint)tmpDBC.ReadInt(
                        i,
                        5);
                    WorldServiceLocator.WSDBCDatabase.FactionTemplatesInfo[templateID].enemyFaction1 = tmpDBC.ReadInt(
                        i,
                        6);
                    WorldServiceLocator.WSDBCDatabase.FactionTemplatesInfo[templateID].enemyFaction2 = tmpDBC.ReadInt(
                        i,
                        7);
                    WorldServiceLocator.WSDBCDatabase.FactionTemplatesInfo[templateID].enemyFaction3 = tmpDBC.ReadInt(
                        i,
                        8);
                    WorldServiceLocator.WSDBCDatabase.FactionTemplatesInfo[templateID].enemyFaction4 = tmpDBC.ReadInt(
                        i,
                        9);
                    WorldServiceLocator.WSDBCDatabase.FactionTemplatesInfo[templateID].friendFaction1 = tmpDBC.ReadInt(
                        i,
                        10);
                    WorldServiceLocator.WSDBCDatabase.FactionTemplatesInfo[templateID].friendFaction2 = tmpDBC.ReadInt(
                        i,
                        11);
                    WorldServiceLocator.WSDBCDatabase.FactionTemplatesInfo[templateID].friendFaction3 = tmpDBC.ReadInt(
                        i,
                        12);
                    WorldServiceLocator.WSDBCDatabase.FactionTemplatesInfo[templateID].friendFaction4 = tmpDBC.ReadInt(
                        i,
                        13);
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} FactionTemplates initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: FactionTemplate is Missing.", ex);
            }
        }
    }
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSLoot.Locks[lockID] = new WS_Loot.TLock(
                        keyType,
                        key,
                        (short)reqMining,
                        (short)reqLockSkill);
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} Locks initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSDBCDatabase.SkillLineAbility
                        .Add(tmpSkillLineAbility.ID, tmpSkillLineAbility);
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} SkillLineAbilitys initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: SkillLineAbility is Missing.", ex);
            }
        }
    }
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSDBCDatabase.SkillLines[skillID] = tmpDBC.ReadInt(i, 1);
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} SkillLines initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSSpells.SpellCastTime[spellCastID] = tmpDBC.ReadInt(i, 1);
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} SpellCastTimes initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: SpellCastTimes is Missing.", ex);
            }
        }
    }
    ...
    public void InitializeSpellChains()
    {
        try
        {
            ...
            WorldServiceLocator.WorldServer.WorldDatabase
                .Query("SELECT spell_id, prev_spell FROM spell_chain", ref spellChainQuery);
            ...
            } catch(Exception ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(
                        LogType.FAILED,
                        "SpellChains enumeration failed  {0} : {1} : {2}",
                        spellChainQuery,
                        enumerator,
                        ex);
            } finally
            ...
            WorldServiceLocator.WorldServer.Log
                .WriteLine(
                    LogType.INFORMATION,
                    "Database: {0} SpellChains initialized.",
                    spellChainQuery.Rows.Count);
        } catch(DirectoryNotFoundException ex)
        {
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSSpells.SpellDuration[spellDurationIndex] = tmpDBC.ReadInt(i, 1);
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} SpellDurations initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: SpellDurations is Missing.", ex);
            }
        }
    }
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSSpells.SpellFocusObject[spellFocusIndex] = tmpDBC.ReadString(i, 1);
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} SpellFocusObjects initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: SpellFocusObjects is Missing.", ex);
            }
        }
    }
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSSpells.SpellRadius[radiusID] = tmpDBC.ReadFloat(i, 1);
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} SpellRadius initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: SpellRadius is Missing.", ex);
            }
        }
    }
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSSpells.SpellRange[spellRangeIndex] = tmpDBC.ReadFloat(i, 2);
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} SpellRanges initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: SpellRanges is Missing.", ex);
            }
        }
    }
    ...
    public async Task InitializeSpellsAsync()
    {
        checked
        {
            try
            {
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: Initializing Spells - This may take a few moments....");
                for(var i = 0; i <= (spellDBC.Rows - 1); i++)
                {
                    try
                    {
                        ...
                        WorldServiceLocator.WSSpells.SPELLs[id] = new WS_Spells.SpellInfo
                        {
                            ...
                            RequiredCasterStance = spellDBC.ReadInt(i, 11),
                        ...
                        do
                        {
                            ...
                            {
                                WorldServiceLocator.WSSpells.SPELLs[id].SpellEffects[j].DamageMultiplier = spellDBC.ReadFloat(
                                    i,
                                    167 + j);
                            }
                    ...
                    {
                        WorldServiceLocator.WorldServer.Log
                            .WriteLine(LogType.FAILED, "Line {0} caused error: {1}", i, ex.ToString());
                    }
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} Spells initialized.", spellDBC.Rows - 1);
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSDBCDatabase.SpellShapeShiftForm
                        .Add(new WS_DBCDatabase.TSpellShapeshiftForm(id, flags1, creatureType, attackSpeed));
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} SpellShapeshiftForms initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: SpellShapeShiftForms is Missing.", ex);
            }
        }
    }
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    {
                        WorldServiceLocator.WSDBCDatabase.TaxiNodes
                            .Add(
                                taxiNode,
                                new WS_DBCDatabase.TTaxiNode(
                                    taxiPosX,
                                    taxiPosY,
                                    taxiPosZ,
                                    taxiMapID,
                                    taxiMountTypeHorde,
                                    taxiMountTypeAlliance));
                    }
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} TaxiNodes initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
            ...
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    if(WorldServiceLocator.MangosConfiguration.World.Maps.Contains(taxiMapID))
                    {
                        ...
                        {
                            WorldServiceLocator.WSDBCDatabase.TaxiPathNodes
                                .Add(taxiPath, new Dictionary<int, WS_DBCDatabase.TTaxiPathNode>());
                        }
                        WorldServiceLocator.WSDBCDatabase.TaxiPathNodes[taxiPath].Add(
                            taxiSeq,
                            new WS_DBCDatabase.TTaxiPathNode(
                                taxiPosX,
                                taxiPosY,
                                taxiPosZ,
                                taxiMapID,
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} TaxiPathNodes initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: TaxiPathNode is Missing.", ex);
            }
        }
    }
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSDBCDatabase.TaxiPaths
                        .Add(taxiNode, new WS_DBCDatabase.TTaxiPath(taxiFrom, taxiTo, taxiPrice));
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} TaxiPaths initialized.", tmpDBC.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
    ...
    public async Task LoadAuctionHouseDbcAsync()
    {
        checked
        {
            try
            {
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} AuctionHouses initialized.", dbc.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: AuctionHouse is Missing.", ex);
            }
        }
    }
    ...
    public void LoadCreatureEquipTable()
    {
        try
        {
            ...
            WorldServiceLocator.WorldServer.WorldDatabase
                .Query("SELECT * FROM creature_equip_template_raw;", ref equipQuery);
            IEnumerator enumerator = default;
            try
            {
                ...
                while(enumerator.MoveNext())
                {
                    ...
                    if(!WorldServiceLocator.WSDBCDatabase.CreatureEquip.ContainsKey(entry))
                    {
                        try
                        {
                            WorldServiceLocator.WSDBCDatabase.CreatureEquip
                                .Add(
                                    entry,
                                    new WS_DBCDatabase.CreatureEquipInfo(
                                        row.As<int>("equipmodel1"),
                                        row.As<int>("equipmodel2"),
                                        row.As<int>("equipmodel3"),
                                        row.As<uint>("equipinfo1"),
                                        row.As<uint>("equipinfo2"),
                                        row.As<uint>("equipinfo3"),
                                        row.As<int>("equipslot1"),
                                        row.As<int>("equipslot2"),
                                        row.As<int>("equipslot3")));
                        } catch(DataException ex)
                        {
                            WorldServiceLocator.WorldServer.Log
                                .WriteLine(
                                    LogType.FAILED,
                                    $"Creature_Equip_Template_raw: Unable to equip items {entry} for Creature ",
                                    entry,
                                    ex);
                        }
                    }
            ...
            } catch(Exception ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(
                        LogType.FAILED,
                        "Creature equips enumeration failed  {0} : {1} : {2}",
                        equipQuery,
                        enumerator,
                        ex);
            } finally
            ...
            WorldServiceLocator.WorldServer.Log
                .WriteLine(LogType.INFORMATION, "Database: {0} creature equips initialized.", equipQuery.Rows.Count);
        } catch(DataException ex2)
        {
            WorldServiceLocator.WorldServer.Log
                .WriteLine(LogType.FAILED, "Database: Creature_Equip_Template_raw is Missing.", ex2);
        }
    }
    ...
    public async Task LoadCreatureFamilyDbcAsync()
    {
        checked
        {
            try
            {
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} CreatureFamilys initialized.", dbc.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: CreatureFamily is Missing.", ex);
            }
        }
    }
        ...
        try
        {
            ...
            } catch(Exception ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(
                        LogType.FAILED,
                        "Creature gossip enumeration failed  {0} : {1} : {2}",
                        gossipQuery,
                        enumerator,
                        ex);
            } finally
            ...
            WorldServiceLocator.WorldServer.Log
                .WriteLine(
                    LogType.INFORMATION,
                    "Database: {0} creature gossips initialized.",
                    WorldServiceLocator.WSDBCDatabase.CreatureGossip.Count);
        } catch(DirectoryNotFoundException ex)
        {
    ...
    public void LoadCreatureModelInfo()
    {
        try
        {
            ...
            WorldServiceLocator.WorldServer.WorldDatabase
                .Query("SELECT * FROM creature_model_info;", ref modelQuery);
            IEnumerator enumerator = default;
            try
            {
                ...
                while(enumerator.MoveNext())
                {
                    ...
                    {
                        WorldServiceLocator.WSDBCDatabase.CreatureModel
                            .Add(
                                entry,
                                new WS_DBCDatabase.CreatureModelInfo(
                                    row.As<float>("bounding_radius"),
                                    row.As<float>("combat_reach"),
                                    row.As<byte>("gender"),
                                    row.As<int>("modelid_other_gender")));
                    }
                }
            } catch(Exception ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(
                        LogType.FAILED,
                        "Creature_Model_Info enumeration failed  {0} : {1} : {2}",
                        modelQuery,
                        enumerator,
                        ex);
            } finally
            ...
            WorldServiceLocator.WorldServer.Log
                .WriteLine(LogType.INFORMATION, "Database: {0} creature models initialized.", modelQuery.Rows.Count);
        } catch(DirectoryNotFoundException ex)
        {
            WorldServiceLocator.WorldServer.Log
                .WriteLine(LogType.FAILED, "Database: Creature_Model_Info is Missing.", ex);
        }
    }
    ...
    public void LoadCreatureMovements()
    {
        try
        {
            ...
            WorldServiceLocator.WorldServer.WorldDatabase
                .Query("SELECT * FROM waypoint_data ORDER BY id, point;", ref movementsQuery);
            IEnumerator enumerator = default;
            try
            {
                ...
                while(enumerator.MoveNext())
                {
                    ...
                    {
                        WorldServiceLocator.WSDBCDatabase.CreatureMovement
                            .Add(id, new Dictionary<int, WS_DBCDatabase.CreatureMovePoint>());
                    }
                    WorldServiceLocator.WSDBCDatabase.CreatureMovement[id].Add(
                        row.As<int>("point"),
                        new WS_DBCDatabase.CreatureMovePoint(
                            row.As<float>("position_x"),
                            row.As<float>("position_y"),
                            row.As<float>("position_z"),
                            row.As<int>("delay"),
                            row.As<int>("move_flag"),
                            row.As<int>("action"),
                            row.As<int>("action_chance")));
                }
            } catch(Exception ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(
                        LogType.FAILED,
                        "Creature movements enumeration failed  {0} : {1} : {2}",
                        movementsQuery,
                        enumerator,
                        ex);
            } finally
            ...
            WorldServiceLocator.WorldServer.Log
                .WriteLine(
                    LogType.INFORMATION,
                    "Database: {0} creature movements for {1} creatures initialized.",
                    movementsQuery.Rows.Count,
                    WorldServiceLocator.WSDBCDatabase.CreatureMovement.Count);
        } catch(DirectoryNotFoundException ex)
        {
    ...
    public async Task LoadItemDisplayInfoDbcAsync()
    {
        checked
        {
            try
            {
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} ItemDisplayInfos initialized.", dbc.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: ItemDisplayInfo is Missing.", ex);
            }
        }
    }
    ...
    public async Task LoadItemRandomPropertiesDbcAsync()
    {
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    WS_DBCDatabase.TItemRandomPropertiesInfo tmpInfo = new() { ID = dbc.ReadInt(i, 0) };
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} ItemRandomProperties initialized.", dbc.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: ItemRandomProperties is Missing.", ex);
            }
        }
    }
    ...
    public async Task LoadItemSetAsync()
    {
        checked
        {
            try
            {
                ...
                var num = dbc.Rows - 1;
                const int requiredSkillID = default;
                const int requiredSkillValue = default;
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSDBCDatabase.ItemSet
                        .Add(
                            id,
                            new WS_DBCDatabase.TItemSet(
                                name,
                                itemID,
                                spellID,
                                itemCount,
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} ItemSets initialized.", dbc.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
    ...
    public void LoadLootStores()
    {
        ...
        WorldServiceLocator.WSLoot.LootTemplates_Pickpocketing = new WS_Loot.LootStore(
    ...
    public void LoadQuestStartersAndFinishers()
    {
        ...
        WorldServiceLocator.WorldServer.WorldDatabase
            .Query("SELECT * FROM quest_relations where actor=0 and role =0;", ref questStarters);
        IEnumerator enumerator = default;
        try
        {
        ...
        } catch(Exception ex)
        {
            WorldServiceLocator.WorldServer.Log
                .WriteLine(
                    LogType.FAILED,
                    "CreatureQuestStarters enumeration failed  {0} : {1} : {2}",
                    questStarters,
                    enumerator,
                    ex);
        } finally
        ...
        questStarters.Clear();
        WorldServiceLocator.WorldServer.WorldDatabase
            .Query("SELECT * FROM quest_relations where actor=1 and role=0;", ref questStarters);
        ...
        } catch(Exception ex)
        {
            WorldServiceLocator.WorldServer.Log
                .WriteLine(
                    LogType.FAILED,
                    "GameobjectQuestStarters enumeration failed  {0} : {1} : {2}",
                    questStarters,
                    enumerator,
                    ex);
        } finally
        ...
        checked
        {
            ...
            WorldServiceLocator.WorldServer.Log
                .WriteLine(
                    LogType.INFORMATION,
                    "Database: {0} queststarters initated for {1} creatures and {2} gameobjects.",
                    questStartersAmount,
                    WorldServiceLocator.WorldServer.CreatureQuestStarters.Count,
                    WorldServiceLocator.WorldServer.GameObjectQuestStarters.Count);
            questStarters.Clear();
            DataTable questFinishers = new();
            WorldServiceLocator.WorldServer.WorldDatabase
                .Query("SELECT * FROM quest_relations where actor=0 and role=1;", ref questFinishers);
            ...
            } catch(Exception ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(
                        LogType.FAILED,
                        "CreatureQuestFinishers enumeration failed  {0} : {1} : {2}",
                        questFinishers,
                        enumerator,
                        ex);
            } finally
            ...
            WorldServiceLocator.WorldServer.WorldDatabase
                .Query("SELECT * FROM quest_relations where actor=1 and role=1;", ref questFinishers);
            ...
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "Database: Quest_Relations is Missing.", ex);
            } finally
            {
            ...
            WorldServiceLocator.WorldServer.Log
                .WriteLine(
                    LogType.INFORMATION,
                    "Database: {0} questfinishers initated for {1} creatures and {2} gameobjects.",
                    questFinishersAmount,
                    WorldServiceLocator.WorldServer.CreatureQuestFinishers.Count,
                    WorldServiceLocator.WorldServer.GameobjectQuestFinishers.Count);
            questFinishers.Clear();
        }
    }
        ...
        checked
        {
            try
            {
                ...
                for(var i = 0; i <= num; i++)
                {
                    ...
                    WorldServiceLocator.WSDBCDatabase.SpellItemEnchantments
                        .Add(id, new WS_DBCDatabase.TSpellItemEnchantment(type, amount, spellID, auraID, slot));
                }
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} SpellItemEnchantments initialized.", dbc.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "DBC File: SpellItemEnchantment is Missing.", ex);
            }
        }
    }
    ...
    public async Task LoadTalentDbcAsync()
    {
        checked
        {
            try
            {
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} Talents initialized.", dbc.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
    ...
    public async Task LoadTalentTabDbcAsync()
    {
        checked
        {
            try
            {
                ...
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.INFORMATION, "DBC: {0} Talent tabs initialized.", dbc.Rows - 1);
            } catch(DirectoryNotFoundException ex)
            {
        ...
        try
        {
            ...
            try
            {
                ...
                while(enumerator.MoveNext())
                {
                    ...
                    if(!WorldServiceLocator.WSWeather.WeatherZones.ContainsKey(zone))
                    {
                        ...
                        zoneChanges.Seasons[0] = new WS_Weather.WeatherSeasonChances(
                            row.As<int>("spring_rain_chance"),
                            row.As<int>("spring_snow_chance"),
                            row.As<int>("spring_storm_chance"));
                        zoneChanges.Seasons[1] = new WS_Weather.WeatherSeasonChances(
                            row.As<int>("summer_rain_chance"),
                            row.As<int>("summer_snow_chance"),
                            row.As<int>("summer_storm_chance"));
                        zoneChanges.Seasons[2] = new WS_Weather.WeatherSeasonChances(
                            row.As<int>("fall_rain_chance"),
                            row.As<int>("fall_snow_chance"),
                            row.As<int>("fall_storm_chance"));
                        zoneChanges.Seasons[3] = new WS_Weather.WeatherSeasonChances(
                            row.As<int>("winter_rain_chance"),
                            row.As<int>("winter_snow_chance"),
                            row.As<int>("winter_storm_chance"));
            ...
            } catch(Exception ex)
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(
                        LogType.FAILED,
                        "Game_Weather enumeration failed  {0} : {1} : {2}",
                        weatherQuery,
                        enumerator,
                        ex);
            } finally
            ...
            WorldServiceLocator.WorldServer.Log
                .WriteLine(LogType.INFORMATION, "Database: {0} Weather zones initialized.", weatherQuery.Rows.Count);
        } catch(DirectoryNotFoundException ex)
        {
