...
{
    public void On_CMSG_ACCEPT_TRADE(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_ACCEPT_TRADE", client.IP, client.Port);
        client.Character.tradeInfo.DoTrade(ref client.Character);
    }

    public void On_CMSG_BEGIN_TRADE(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_BEGIN_TRADE", client.IP, client.Port);
        checked
        {
            client.Character.tradeInfo.ID++;
            Packets.Packets.PacketClass response = new(Opcodes.SMSG_TRADE_STATUS);
            try
            {
                response.AddInt32(2);
    ...
    public void On_CMSG_BUSY_TRADE(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_BUSY_TRADE", client.IP, client.Port);
    }

    public void On_CMSG_CANCEL_TRADE(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
    ...
    public void On_CMSG_CLEAR_TRADE_ITEM(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_CLEAR_TRADE_ITEM [slot={2}]", client.IP, client.Port, slot);
    ...
    public void On_CMSG_IGNORE_TRADE(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_IGNORE_TRADE", client.IP, client.Port);
    }

    public void On_CMSG_INITIATE_TRADE(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(
                LogType.DEBUG,
                "[{0}:{1}] CMSG_INITIATE_TRADE [Trader={2} Target={3}]",
                client.IP,
                client.Port,
        ...
        {
            Packets.Packets.PacketClass response6 = new(Opcodes.SMSG_TRADE_STATUS);
            try
            {
        ...
        {
            Packets.Packets.PacketClass response8 = new(Opcodes.SMSG_TRADE_STATUS);
            try
            {
        ...
        {
            Packets.Packets.PacketClass response10 = new(Opcodes.SMSG_TRADE_STATUS);
            try
            {
        ...
        {
            Packets.Packets.PacketClass response12 = new(Opcodes.SMSG_TRADE_STATUS);
            try
            {
        ...
        {
            Packets.Packets.PacketClass response13 = new(Opcodes.SMSG_TRADE_STATUS);
            try
            {
        ...
        {
            Packets.Packets.PacketClass response11 = new(Opcodes.SMSG_TRADE_STATUS);
            try
            {
        ...
        {
            Packets.Packets.PacketClass response9 = new(Opcodes.SMSG_TRADE_STATUS);
            try
            {
        ...
        if(client.Character.tradeInfo != null)
        {
            Packets.Packets.PacketClass response7 = new(Opcodes.SMSG_TRADE_STATUS);
            try
            {
        ...
        {
            Packets.Packets.PacketClass response5 = new(Opcodes.SMSG_TRADE_STATUS);
            try
            {
        ...
        {
            Packets.Packets.PacketClass response4 = new(Opcodes.SMSG_TRADE_STATUS);
            try
            {
        ...
        if(WorldServiceLocator.WSCombat
                .GetDistance(client.Character, WorldServiceLocator.WorldServer.CHARACTERs[targetGUID]) >
            30f)
        {
            Packets.Packets.PacketClass response3 = new(Opcodes.SMSG_TRADE_STATUS);
            try
            {
        ...
        {
            Packets.Packets.PacketClass response2 = new(Opcodes.SMSG_TRADE_STATUS);
            try
            {
        ...
        Packets.Packets.PacketClass response_ok = new(Opcodes.SMSG_TRADE_STATUS);
        try
        {
    ...
    public void On_CMSG_SET_TRADE_GOLD(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_SET_TRADE_GOLD [gold={2}]", client.IP, client.Port, gold);
        if(client.Character.tradeInfo != null)
        {
            if(client.Character.tradeInfo.Trader == client.Character)
            {
    ...
    public void On_CMSG_SET_TRADE_ITEM(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(
                LogType.DEBUG,
                "[{0}:{1}] CMSG_SET_TRADE_ITEM [slot={2} myBag={3} mySlot={4}]",
                client.IP,
                client.Port,
                slot,
                myBag,
    ...
    public void On_CMSG_UNACCEPT_TRADE(ref Packets.Packets.PacketClass packet, ref WS_Network.ClientClass client)
    {
        if(packet is null)
        {
            throw new ArgumentNullException(nameof(packet));
        ...
        WorldServiceLocator.WorldServer.Log
            .WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_UNACCEPT_TRADE", client.IP, client.Port);
        Packets.Packets.PacketClass response = new(Opcodes.SMSG_TRADE_STATUS);
        try
        {
            response.AddInt32(7);
    ...
    public class TTradeInfo : IDisposable
    {
        ...
        public TTradeInfo(ref WS_PlayerData.CharacterObject Trader_, ref WS_PlayerData.CharacterObject Target_)
        {
            ...
            Trader = null;
            Target = null;
            TraderSlots = (new int[7] { -1, -1, -1, -1, -1, -1, -1 });
            TraderGold = 0u;
            TraderAccept = false;
            TargetSlots = (new int[7] { -1, -1, -1, -1, -1, -1, -1 });
            TargetGold = 0u;
            TargetAccept = false;
            Trader = Trader_ ?? throw new ArgumentNullException(nameof(Trader_));
            Target = Target_ ?? throw new ArgumentNullException(nameof(Target_));
        ...
        private void DoTrade()
        {
            ...
            try
            {
                ...
                {
                    Packets.Packets.PacketClass responseUnAccept2 = new(Opcodes.SMSG_TRADE_STATUS);
                    try
                    {
                    ...
                    Packets.Packets.PacketClass responseNoSlot2 = new(Opcodes.SMSG_INVENTORY_CHANGE_FAILURE);
                    try
                    {
                ...
                {
                    Packets.Packets.PacketClass responseUnAccept = new(Opcodes.SMSG_TRADE_STATUS);
                    try
                    {
                    ...
                    Packets.Packets.PacketClass responseNoSlot = new(Opcodes.SMSG_INVENTORY_CHANGE_FAILURE);
                    try
                    {
                    ...
                    do
                    {
                        checked
                        {
                            if(TraderSlots[j] > 0)
                            {
                                ...
                                var myItem2 = (myBag2 != 0)
                                    ? Trader.Items[myBag2].Items[mySlot2]
                                    : Trader.Items[mySlot2];
                            ...
                            if(TargetSlots[j] > 0)
                            {
                                ...
                                var myItem = (myBag != 0)
                                    ? Target.Items[myBag].Items[mySlot]
                                    : Target.Items[mySlot];
            ...
            {
                WorldServiceLocator.WorldServer.Log
                    .WriteLine(LogType.FAILED, "Error doing trade: {0}{1}", Environment.NewLine, e.ToString());
            }
        }
        ...
        public void SendTradeUpdateToTarget()
        {
            ...
            checked
            {
                Packets.Packets.PacketClass packet = new(Opcodes.SMSG_TRADE_STATUS_EXTENDED);
                try
                {
                    packet.AddInt8(1);
                    packet.AddInt32(7);
                    ...
                    do
                    {
                        ...
                        if(TraderSlots[i] > 0)
                        {
                            ...
                            var myItem = (myBag != 0) ? Trader.Items[myBag].Items[mySlot] : Trader.Items[mySlot];
