    ...
    public void On_MSG_MOVE_HEARTBEAT(PacketClass packet, ClientClass client)
    {
        ...
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_HEARTBEAT error occured [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
        ...
        {
            PacketClass statsPacket = new(Opcodes.UMSG_UPDATE_GROUP_MEMBERS)
            {
                Data =
                    client.Character.GetWorld
                        .GroupMemberStats(
                            client.Character.Guid,
                            ((int)Functions.PartyMemberStatsFlag.GROUP_UPDATE_FLAG_POSITION) +
                                    ((int)Functions.PartyMemberStatsFlag.GROUP_UPDATE_FLAG_ZONE))
            };
    ...
    public void On_MSG_MOVE_SET_FACING(PacketClass packet, ClientClass client)
    {
        ...
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_SET_FACING error occured [{2}",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_MOVE_START_FORWARD(PacketClass packet, ClientClass client)
    {
        ...
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_START_FOWARD error occured [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_MOVE_START_PITCH_DOWN(PacketClass packet, ClientClass client)
    {
        ...
        try
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.DEBUG,
                    "[{0}:{1}] MSG_MOVE_START_PITCH_DOWN [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_START_PITCH_DOWN error occured [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_MOVE_START_PITCH_UP(PacketClass packet, ClientClass client)
    {
        ...
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_START_PITCH_UP error occured [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_MOVE_START_STRAFE_RIGHT(PacketClass packet, ClientClass client)
    {
        ...
        try
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.DEBUG,
                    "[{0}:{1}] MSG_MOVE_START_STRAFE_RIGHT [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_START_STRAFE_RIGHT error occured [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_MOVE_START_SWIM(PacketClass packet, ClientClass client)
    {
        ...
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_START_SWIM error occured [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_MOVE_START_TURN_LEFT(PacketClass packet, ClientClass client)
    {
        ...
        try
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.DEBUG,
                    "[{0}:{1}] MSG_MOVE_START_TURN_LEFT [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_START_TURN_LEFT error occured [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_MOVE_START_TURN_RIGHT(PacketClass packet, ClientClass client)
    {
        ...
        try
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.DEBUG,
                    "[{0}:{1}] MSG_MOVE_START_TURN_RIGHT [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_START_TURN_RIGHT error occured [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_MOVE_STOP(PacketClass packet, ClientClass client)
    {
        ...
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_STOP error occured [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_MOVE_STOP_PITCH(PacketClass packet, ClientClass client)
    {
        ...
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_STOP_PITCH error occured [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_MOVE_STOP_STRAFE(PacketClass packet, ClientClass client)
    {
        ...
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_STOP_STRAFE error occured [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_MOVE_STOP_SWIM(PacketClass packet, ClientClass client)
    {
        ...
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_STOP_SWIM error occured [{2}",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_MOVE_STOP_TURN(PacketClass packet, ClientClass client)
    {
        ...
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_STOP_TURN error occured [{2}",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_MOVE_STRAFE_LEFT(PacketClass packet, ClientClass client)
    {
        ...
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_MOVE_STRAFE_LEFT error occured [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
    ...
    public void On_MSG_START_BACKWARD(PacketClass packet, ClientClass client)
    {
        ...
        } catch
        {
            ...
            _clusterServiceLocator.WorldCluster.Log
                .WriteLine(
                    LogType.WARNING,
                    "[{0}:{1}] MSG_START_BACKWARD error occured [{2}]",
                    client.IP,
                    client.Port,
                    client.Character.Map);
            return;
